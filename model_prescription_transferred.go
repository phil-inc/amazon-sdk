...
type PrescriptionTransferred struct {
	...
	// The number of refills left on the prescription including the first fill. This field will be marked as required for both NewRx and previously dispensed Rx starting from 2025-03-12.
	RefillsRemaining *float64 `json:"refillsRemaining,omitempty"`
	// The number of refills being transferred to Amazon Pharmacy including the first fill.
