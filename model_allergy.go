...
// checks if the Allergy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Allergy{}

// Allergy Structure representing an allergy of the patient.
type Allergy struct {
	// Patient's allergy code, Allergy code should follow the AllergyCodeType input's standard code format.
	Code     *string          `json:"code,omitempty" validate:"regexp=^(([0-9]{6,18})|([0-9]{1,7}))$"`
	CodeType *AllergyCodeType `json:"codeType,omitempty"`
	// A human-readable text value of the allergy. Eg, Peanut Allergy
	TextValue string `json:"textValue" validate:"regexp=^\\\\s*\\\\S.*$"`
}

type _Allergy Allergy
...
// SetCodeType gets a reference to the given AllergyCodeType and assigns it to the CodeType field.
...
func (o Allergy) MarshalJSON() ([]byte, error) {
...
func (o Allergy) ToMap() (map[string]interface{}, error) {
...
func (o *Allergy) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varAllergy)

	if err != nil {
		return err
	}

	*o = Allergy(varAllergy)

	return err
}

type NullableAllergy struct {
	value *Allergy
	isSet bool
}

func (v NullableAllergy) Get() *Allergy {
	return v.value
}

func (v *NullableAllergy) Set(val *Allergy) {
	v.value = val
	v.isSet = true
}

func (v NullableAllergy) IsSet() bool {
	return v.isSet
}

func (v *NullableAllergy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllergy(val *Allergy) *NullableAllergy {
	return &NullableAllergy{value: val, isSet: true}
}

func (v NullableAllergy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllergy) UnmarshalJSON(src []byte) error {
	v.isSet = true
