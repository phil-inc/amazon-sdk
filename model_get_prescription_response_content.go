...
// checks if the GetPrescriptionResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPrescriptionResponseContent{}

// GetPrescriptionResponseContent Structure representing the response for getting a prescription.
type GetPrescriptionResponseContent struct {
	Prescription Prescription `json:"prescription"`
	// The partner Prescription ID of the requested prescription.
	PartnerPrescriptionId string `json:"partnerPrescriptionId" validate:"regexp=^[0-9a-zA-Z-]{1,40}$"`
}

type _GetPrescriptionResponseContent GetPrescriptionResponseContent
...
func NewGetPrescriptionResponseContent(prescription Prescription, partnerPrescriptionId string) *GetPrescriptionResponseContent {
	this := GetPrescriptionResponseContent{}
...
func (o GetPrescriptionResponseContent) MarshalJSON() ([]byte, error) {
...
func (o GetPrescriptionResponseContent) ToMap() (map[string]interface{}, error) {
...
func (o *GetPrescriptionResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varGetPrescriptionResponseContent := _GetPrescriptionResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetPrescriptionResponseContent)

	if err != nil {
		return err
	}

	*o = GetPrescriptionResponseContent(varGetPrescriptionResponseContent)

	return err
}

type NullableGetPrescriptionResponseContent struct {
	value *GetPrescriptionResponseContent
	isSet bool
}

func (v NullableGetPrescriptionResponseContent) Get() *GetPrescriptionResponseContent {
	return v.value
}

func (v *NullableGetPrescriptionResponseContent) Set(val *GetPrescriptionResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPrescriptionResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPrescriptionResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPrescriptionResponseContent(val *GetPrescriptionResponseContent) *NullableGetPrescriptionResponseContent {
	return &NullableGetPrescriptionResponseContent{value: val, isSet: true}
}

func (v NullableGetPrescriptionResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPrescriptionResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
