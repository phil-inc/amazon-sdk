...
// CardDetails Structure representing the details of a payment card.
type CardDetails struct {
	// The encrypted card number.
	EncryptedCardNumber string `json:"encryptedCardNumber" validate:"regexp=^\\\\s*\\\\S.*$"`
	// The Name of Card Holder owner as it appears on the Card.
	CardHolderName string `json:"cardHolderName" validate:"regexp=^\\\\s*\\\\S.*$"`
...
// GetEncryptedCardNumber returns the EncryptedCardNumber field value
...
// GetEncryptedCardNumberOk returns a tuple with the EncryptedCardNumber field value
...
// SetEncryptedCardNumber sets field value
...
func (o *CardDetails) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varCardDetails)
