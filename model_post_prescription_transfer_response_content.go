...
// checks if the PostPrescriptionTransferResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostPrescriptionTransferResponseContent{}

// PostPrescriptionTransferResponseContent Structure representing the response for a prescription transfer request.
type PostPrescriptionTransferResponseContent struct {
	TransferRequestStatus TransferRequestStatus `json:"transferRequestStatus"`
}

type _PostPrescriptionTransferResponseContent PostPrescriptionTransferResponseContent
...
func NewPostPrescriptionTransferResponseContent(transferRequestStatus TransferRequestStatus) *PostPrescriptionTransferResponseContent {
	this := PostPrescriptionTransferResponseContent{}
...
// GetTransferRequestStatus returns the TransferRequestStatus field value
...
// GetTransferRequestStatusOk returns a tuple with the TransferRequestStatus field value
...
func (o PostPrescriptionTransferResponseContent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["transferRequestStatus"] = o.TransferRequestStatus
	return toSerialize, nil
}

func (o *PostPrescriptionTransferResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varPostPrescriptionTransferResponseContent := _PostPrescriptionTransferResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostPrescriptionTransferResponseContent)

	if err != nil {
		return err
	}

	*o = PostPrescriptionTransferResponseContent(varPostPrescriptionTransferResponseContent)

	return err
}

type NullablePostPrescriptionTransferResponseContent struct {
	value *PostPrescriptionTransferResponseContent
	isSet bool
}

func (v NullablePostPrescriptionTransferResponseContent) Get() *PostPrescriptionTransferResponseContent {
	return v.value
}

func (v *NullablePostPrescriptionTransferResponseContent) Set(val *PostPrescriptionTransferResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullablePostPrescriptionTransferResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullablePostPrescriptionTransferResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostPrescriptionTransferResponseContent(val *PostPrescriptionTransferResponseContent) *NullablePostPrescriptionTransferResponseContent {
	return &NullablePostPrescriptionTransferResponseContent{value: val, isSet: true}
}

func (v NullablePostPrescriptionTransferResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostPrescriptionTransferResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
