...
// Quantity Structure representing the quantity of a medication.
type Quantity struct {
	// Total quantity of the prescription.
	Value float64 `json:"value"`
	// A NCI Code, NCPDP Drug QuantityUnitOfMeasure Terminology, e.g., C48542. This shape is deprecated: This field will be replaced by `quantityUnitOfMeasureCode`. This field will no longer be supported starting from 2025-03-12.
	// Deprecated
	UnitOfMeasureCode string `json:"unitOfMeasureCode" validate:"regexp=^\\\\s*\\\\S.*$"`
	QuantityUnitOfMeasureCode *QuantityUnitOfMeasureCode `json:"quantityUnitOfMeasureCode,omitempty"`
	CodeListQualifier *QuantityCodeListQualifier `json:"codeListQualifier,omitempty"`
}
...
// GetUnitOfMeasureCode returns the UnitOfMeasureCode field value
// Deprecated
...
// GetUnitOfMeasureCodeOk returns a tuple with the UnitOfMeasureCode field value
// and a boolean to check if the value has been set.
// Deprecated
...
// SetUnitOfMeasureCode sets field value
// Deprecated
...
func (o *Quantity) GetQuantityUnitOfMeasureCode() QuantityUnitOfMeasureCode {
	if o == nil || IsNil(o.QuantityUnitOfMeasureCode) {
		var ret QuantityUnitOfMeasureCode
		return ret
	}
...
// SetQuantityUnitOfMeasureCode gets a reference to the given QuantityUnitOfMeasureCode and assigns it to the QuantityUnitOfMeasureCode field.
func (o *Quantity) SetQuantityUnitOfMeasureCode(v QuantityUnitOfMeasureCode) {
	o.QuantityUnitOfMeasureCode = &v
}

// GetCodeListQualifier returns the CodeListQualifier field value if set, zero value otherwise.
func (o *Quantity) GetCodeListQualifier() QuantityCodeListQualifier {
	if o == nil || IsNil(o.CodeListQualifier) {
		var ret QuantityCodeListQualifier
		return ret
	}
	return *o.CodeListQualifier
}

// GetCodeListQualifierOk returns a tuple with the CodeListQualifier field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Quantity) GetCodeListQualifierOk() (*QuantityCodeListQualifier, bool) {
	if o == nil || IsNil(o.CodeListQualifier) {
		return nil, false
	}
	return o.CodeListQualifier, true
}
...
// SetCodeListQualifier gets a reference to the given QuantityCodeListQualifier and assigns it to the CodeListQualifier field.
func (o *Quantity) SetCodeListQualifier(v QuantityCodeListQualifier) {
	o.CodeListQualifier = &v
}
...
func (o Quantity) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.QuantityUnitOfMeasureCode) {
		toSerialize["quantityUnitOfMeasureCode"] = o.QuantityUnitOfMeasureCode
	}
	if !IsNil(o.CodeListQualifier) {
		toSerialize["codeListQualifier"] = o.CodeListQualifier
	}
