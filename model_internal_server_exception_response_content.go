...
// InternalServerExceptionResponseContent This exception is thrown when the service encounters an internal exception while processing the request. This is a retriable exception.
type InternalServerExceptionResponseContent struct {
	// A human-readable message describing the internal server exception usually due to an internal failure in the Amazon Pharmacy service.
...
func (o InternalServerExceptionResponseContent) MarshalJSON() ([]byte, error) {
...
func (o *InternalServerExceptionResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varInternalServerExceptionResponseContent := _InternalServerExceptionResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInternalServerExceptionResponseContent)

	if err != nil {
		return err
	}

	*o = InternalServerExceptionResponseContent(varInternalServerExceptionResponseContent)
