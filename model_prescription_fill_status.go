...
// PrescriptionFillStatus Enum representing the status for the fill associated with prescription.  `PENDING` - Indicates fill has been created and waiting to be processed.  `PURCHASED` - Indicates that customer has completed check out if needed.  `CANCELED` - Indicates that the order the fill was associated with was canceled.  `COMPLETE` - Indicates that the fill has been dispensed as part of fulfilling the order.
type PrescriptionFillStatus string

// List of PrescriptionFillStatus
const (
	PENDING PrescriptionFillStatus = "PENDING"
	PURCHASED PrescriptionFillStatus = "PURCHASED"
	CANCELED PrescriptionFillStatus = "CANCELED"
	COMPLETE PrescriptionFillStatus = "COMPLETE"
)

// All allowed values of PrescriptionFillStatus enum
var AllowedPrescriptionFillStatusEnumValues = []PrescriptionFillStatus{
	"PENDING",
	"PURCHASED",
	"CANCELED",
	"COMPLETE",
...
func (v *PrescriptionFillStatus) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PrescriptionFillStatus(value)
	for _, existing := range AllowedPrescriptionFillStatusEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PrescriptionFillStatus", value)
}

// NewPrescriptionFillStatusFromValue returns a pointer to a valid PrescriptionFillStatus
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPrescriptionFillStatusFromValue(v string) (*PrescriptionFillStatus, error) {
	ev := PrescriptionFillStatus(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PrescriptionFillStatus: valid values are %v", v, AllowedPrescriptionFillStatusEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PrescriptionFillStatus) IsValid() bool {
	for _, existing := range AllowedPrescriptionFillStatusEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PrescriptionFillStatus value
func (v PrescriptionFillStatus) Ptr() *PrescriptionFillStatus {
	return &v
}

type NullablePrescriptionFillStatus struct {
	value *PrescriptionFillStatus
	isSet bool
}

func (v NullablePrescriptionFillStatus) Get() *PrescriptionFillStatus {
	return v.value
}

func (v *NullablePrescriptionFillStatus) Set(val *PrescriptionFillStatus) {
	v.value = val
	v.isSet = true
}

func (v NullablePrescriptionFillStatus) IsSet() bool {
	return v.isSet
}

func (v *NullablePrescriptionFillStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrescriptionFillStatus(val *PrescriptionFillStatus) *NullablePrescriptionFillStatus {
	return &NullablePrescriptionFillStatus{value: val, isSet: true}
}

func (v NullablePrescriptionFillStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrescriptionFillStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
