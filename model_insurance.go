...
type Insurance struct {
	...
	// Insurance card number encrypted using the patient-information-encryption-key. The unencrypted value cannot exceed 20 characters.
	EncryptedCardholderId string `json:"encryptedCardholderId" validate:"regexp=^\\\\s*\\\\S.*$"`
}
...
func NewInsurance(binNumber string, personCode string, partnerInsuranceId string, encryptedCardholderId string) *Insurance {
	...
	this.EncryptedCardholderId = encryptedCardholderId
	return &this
}
...
// GetEncryptedCardholderId returns the EncryptedCardholderId field value
...
// GetEncryptedCardholderIdOk returns a tuple with the EncryptedCardholderId field value
// and a boolean to check if the value has been set.
...
// SetEncryptedCardholderId sets field value
