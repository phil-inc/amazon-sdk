...
// Insurance Structure representing insurance information associated with the patient.
type Insurance struct {
	...
	CardholderId *string `json:"cardholderId,omitempty" validate:"regexp=^[a-zA-Z0-9-]*$"`
	// A unique identifier to identify the partner-provided insurance.
	PartnerInsuranceId string `json:"partnerInsuranceId" validate:"regexp=^[0-9a-zA-Z-]{1,40}$"`
	// Deprecated, use cardholderId instead. One of unencrypted or encrypted cardholder is required. Insurance card number encrypted using the patient-information-encryption-key. The unencrypted value cannot exceed 20 characters.  This shape is deprecated.
	// Deprecated
	EncryptedCardholderId *string `json:"encryptedCardholderId,omitempty" validate:"regexp=^\\\\s*\\\\S.*$"`
}

type _Insurance Insurance
...
// GetCardholderId returns the CardholderId field value if set, zero value otherwise.
func (o *Insurance) GetCardholderId() string {
	if o == nil || IsNil(o.CardholderId) {
		var ret string
		return ret
	}
...
// GetCardholderIdOk returns a tuple with the CardholderId field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetCardholderId gets a reference to the given string and assigns it to the CardholderId field.
func (o *Insurance) SetCardholderId(v string) {
	o.CardholderId = &v
}

// GetPartnerInsuranceId returns the PartnerInsuranceId field value
func (o *Insurance) GetPartnerInsuranceId() string {
	...
	return o.PartnerInsuranceId
}

// GetPartnerInsuranceIdOk returns a tuple with the PartnerInsuranceId field value
// and a boolean to check if the value has been set.
func (o *Insurance) GetPartnerInsuranceIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PartnerInsuranceId, true
}

// SetPartnerInsuranceId sets field value
func (o *Insurance) SetPartnerInsuranceId(v string) {
	o.PartnerInsuranceId = v
}

// GetEncryptedCardholderId returns the EncryptedCardholderId field value if set, zero value otherwise.
// Deprecated
func (o *Insurance) GetEncryptedCardholderId() string {
	if o == nil || IsNil(o.EncryptedCardholderId) {
		var ret string
		return ret
	}
	return *o.EncryptedCardholderId
}

// GetEncryptedCardholderIdOk returns a tuple with the EncryptedCardholderId field value if set, nil otherwise
// and a boolean to check if the value has been set.
// Deprecated
func (o *Insurance) GetEncryptedCardholderIdOk() (*string, bool) {
	...
	return o.EncryptedCardholderId, true
}
...
// SetEncryptedCardholderId gets a reference to the given string and assigns it to the EncryptedCardholderId field.
// Deprecated
func (o *Insurance) SetEncryptedCardholderId(v string) {
	o.EncryptedCardholderId = &v
}
...
func (o Insurance) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CardholderId) {
		toSerialize["cardholderId"] = o.CardholderId
	}
	toSerialize["partnerInsuranceId"] = o.PartnerInsuranceId
	if !IsNil(o.EncryptedCardholderId) {
		toSerialize["encryptedCardholderId"] = o.EncryptedCardholderId
	}
	return toSerialize, nil
}

func (o *Insurance) UnmarshalJSON(data []byte) (err error) {
	...
	varInsurance := _Insurance{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInsurance)

	if err != nil {
		return err
	}

	*o = Insurance(varInsurance)
