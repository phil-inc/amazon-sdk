...
// PossibleDemographicFieldsInError This represents Enums of possible demographic fields in error.  `DATE_OF_BIRTH` - Date of birth of patient
type PossibleDemographicFieldsInError string

// List of PossibleDemographicFieldsInError
const (
	DATE_OF_BIRTH PossibleDemographicFieldsInError = "DATE_OF_BIRTH"
)

// All allowed values of PossibleDemographicFieldsInError enum
var AllowedPossibleDemographicFieldsInErrorEnumValues = []PossibleDemographicFieldsInError{
	"DATE_OF_BIRTH",
}

func (v *PossibleDemographicFieldsInError) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PossibleDemographicFieldsInError(value)
	for _, existing := range AllowedPossibleDemographicFieldsInErrorEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PossibleDemographicFieldsInError", value)
}

// NewPossibleDemographicFieldsInErrorFromValue returns a pointer to a valid PossibleDemographicFieldsInError
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPossibleDemographicFieldsInErrorFromValue(v string) (*PossibleDemographicFieldsInError, error) {
	ev := PossibleDemographicFieldsInError(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PossibleDemographicFieldsInError: valid values are %v", v, AllowedPossibleDemographicFieldsInErrorEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PossibleDemographicFieldsInError) IsValid() bool {
	for _, existing := range AllowedPossibleDemographicFieldsInErrorEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PossibleDemographicFieldsInError value
func (v PossibleDemographicFieldsInError) Ptr() *PossibleDemographicFieldsInError {
	return &v
}

type NullablePossibleDemographicFieldsInError struct {
	value *PossibleDemographicFieldsInError
	isSet bool
}

func (v NullablePossibleDemographicFieldsInError) Get() *PossibleDemographicFieldsInError {
	return v.value
}

func (v *NullablePossibleDemographicFieldsInError) Set(val *PossibleDemographicFieldsInError) {
	v.value = val
	v.isSet = true
}

func (v NullablePossibleDemographicFieldsInError) IsSet() bool {
	return v.isSet
}

func (v *NullablePossibleDemographicFieldsInError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePossibleDemographicFieldsInError(val *PossibleDemographicFieldsInError) *NullablePossibleDemographicFieldsInError {
	return &NullablePossibleDemographicFieldsInError{value: val, isSet: true}
}

func (v NullablePossibleDemographicFieldsInError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePossibleDemographicFieldsInError) UnmarshalJSON(src []byte) error {
	v.isSet = true
