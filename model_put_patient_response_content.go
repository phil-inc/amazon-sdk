...
// checks if the PutPatientResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutPatientResponseContent{}

// PutPatientResponseContent Structure representing the PutPatient API response.
type PutPatientResponseContent struct {
	// A unique partner-provided identifier that will be used to identify the patient.
	PartnerPatientId string `json:"partnerPatientId" validate:"regexp=^[0-9a-zA-Z-]{1,40}$"`
}

type _PutPatientResponseContent PutPatientResponseContent
...
func NewPutPatientResponseContent(partnerPatientId string) *PutPatientResponseContent {
	this := PutPatientResponseContent{}
...
func (o PutPatientResponseContent) MarshalJSON() ([]byte, error) {
...
func (o PutPatientResponseContent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["partnerPatientId"] = o.PartnerPatientId
	return toSerialize, nil
}

func (o *PutPatientResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varPutPatientResponseContent := _PutPatientResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPutPatientResponseContent)

	if err != nil {
		return err
	}

	*o = PutPatientResponseContent(varPutPatientResponseContent)

	return err
}

type NullablePutPatientResponseContent struct {
	value *PutPatientResponseContent
	isSet bool
}

func (v NullablePutPatientResponseContent) Get() *PutPatientResponseContent {
	return v.value
}

func (v *NullablePutPatientResponseContent) Set(val *PutPatientResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullablePutPatientResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullablePutPatientResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutPatientResponseContent(val *PutPatientResponseContent) *NullablePutPatientResponseContent {
	return &NullablePutPatientResponseContent{value: val, isSet: true}
}

func (v NullablePutPatientResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutPatientResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
