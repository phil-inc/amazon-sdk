...
// ShippingDetails Structure representing the shipping details of an order.
type ShippingDetails struct {
	// The tracking ID associated with the shipment.
	TrackingId *string `json:"trackingId,omitempty" validate:"regexp=^\\\\s*\\\\S.*$"`
	// The name of the carrier fulfilling the delivery of the shipment.
	Carrier *string `json:"carrier,omitempty" validate:"regexp=^\\\\s*\\\\S.*$"`
	// The estimated arrival date in the format 'YYYY-MM-DDDD' in UTC, e.g., 2023-04-17T03:00:00.000Z.
	EstimatedArrival *string `json:"estimatedArrival,omitempty" validate:"regexp=^\\\\s*\\\\S.*$"`
}
...
// GetEstimatedArrival returns the EstimatedArrival field value if set, zero value otherwise.
func (o *ShippingDetails) GetEstimatedArrival() string {
	if o == nil || IsNil(o.EstimatedArrival) {
		var ret string
		return ret
	}
	return *o.EstimatedArrival
}

// GetEstimatedArrivalOk returns a tuple with the EstimatedArrival field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ShippingDetails) GetEstimatedArrivalOk() (*string, bool) {
	if o == nil || IsNil(o.EstimatedArrival) {
		return nil, false
	}
	return o.EstimatedArrival, true
}
...
// SetEstimatedArrival gets a reference to the given string and assigns it to the EstimatedArrival field.
func (o *ShippingDetails) SetEstimatedArrival(v string) {
	o.EstimatedArrival = &v
}
...
func (o ShippingDetails) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EstimatedArrival) {
		toSerialize["estimatedArrival"] = o.EstimatedArrival
	}
