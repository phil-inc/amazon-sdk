...
// checks if the AdditionalOrderDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdditionalOrderDetails{}

// AdditionalOrderDetails Contains additional, optional, details for an order. Fields in this struct will be non-null in the right conditions.
type AdditionalOrderDetails struct {
	ShippingDetails *ShippingDetails `json:"shippingDetails,omitempty"`
	// API attribute where orders are held till this date and sent for order placement only when the date is passed.
	PlaceOrderOnDate     *string                `json:"placeOrderOnDate,omitempty" validate:"regexp=^\\\\d{4}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$"`
	ClaimRejectedDetails *ClaimRejectionDetails `json:"claimRejectedDetails,omitempty"`
}
...
// SetShippingDetails gets a reference to the given ShippingDetails and assigns it to the ShippingDetails field.
...
// GetClaimRejectedDetails returns the ClaimRejectedDetails field value if set, zero value otherwise.
func (o *AdditionalOrderDetails) GetClaimRejectedDetails() ClaimRejectionDetails {
	if o == nil || IsNil(o.ClaimRejectedDetails) {
		var ret ClaimRejectionDetails
		return ret
	}
	return *o.ClaimRejectedDetails
}

// GetClaimRejectedDetailsOk returns a tuple with the ClaimRejectedDetails field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AdditionalOrderDetails) GetClaimRejectedDetailsOk() (*ClaimRejectionDetails, bool) {
	if o == nil || IsNil(o.ClaimRejectedDetails) {
		return nil, false
	}
	return o.ClaimRejectedDetails, true
}
...
// SetClaimRejectedDetails gets a reference to the given ClaimRejectionDetails and assigns it to the ClaimRejectedDetails field.
func (o *AdditionalOrderDetails) SetClaimRejectedDetails(v ClaimRejectionDetails) {
	o.ClaimRejectedDetails = &v
}

func (o AdditionalOrderDetails) MarshalJSON() ([]byte, error) {
...
func (o AdditionalOrderDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ShippingDetails) {
		toSerialize["shippingDetails"] = o.ShippingDetails
	}
	if !IsNil(o.PlaceOrderOnDate) {
		toSerialize["placeOrderOnDate"] = o.PlaceOrderOnDate
	}
	if !IsNil(o.ClaimRejectedDetails) {
		toSerialize["claimRejectedDetails"] = o.ClaimRejectedDetails
	}
	return toSerialize, nil
}

type NullableAdditionalOrderDetails struct {
	value *AdditionalOrderDetails
	isSet bool
}

func (v NullableAdditionalOrderDetails) Get() *AdditionalOrderDetails {
	return v.value
}

func (v *NullableAdditionalOrderDetails) Set(val *AdditionalOrderDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableAdditionalOrderDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableAdditionalOrderDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdditionalOrderDetails(val *AdditionalOrderDetails) *NullableAdditionalOrderDetails {
	return &NullableAdditionalOrderDetails{value: val, isSet: true}
}

func (v NullableAdditionalOrderDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdditionalOrderDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
