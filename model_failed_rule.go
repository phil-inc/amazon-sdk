...
// FailedRule Details of a failed rule
type FailedRule struct {
	RuleType InsuranceComplianceRuleType `json:"ruleType"`
	// Informational message about the failed rule
	Message *string `json:"message,omitempty"`
}

type _FailedRule FailedRule
...
func (o *FailedRule) GetRuleType() InsuranceComplianceRuleType {
	if o == nil {
		var ret InsuranceComplianceRuleType
		return ret
	}
...
func (o *FailedRule) UnmarshalJSON(data []byte) (err error) {
	...
	varFailedRule := _FailedRule{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFailedRule)

	if err != nil {
		return err
	}

	*o = FailedRule(varFailedRule)
