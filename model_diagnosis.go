...
// checks if the Diagnosis type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Diagnosis{}

// Diagnosis Structure representing a diagnosis.
type Diagnosis struct {
	...
	// A human-readable description of the diagnosis.
...
func (o Diagnosis) MarshalJSON() ([]byte, error) {
...
func (o Diagnosis) ToMap() (map[string]interface{}, error) {
...
type NullableDiagnosis struct {
	value *Diagnosis
	isSet bool
}

func (v NullableDiagnosis) Get() *Diagnosis {
	return v.value
}

func (v *NullableDiagnosis) Set(val *Diagnosis) {
	v.value = val
	v.isSet = true
}

func (v NullableDiagnosis) IsSet() bool {
	return v.isSet
}

func (v *NullableDiagnosis) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiagnosis(val *Diagnosis) *NullableDiagnosis {
	return &NullableDiagnosis{value: val, isSet: true}
}

func (v NullableDiagnosis) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiagnosis) UnmarshalJSON(src []byte) error {
	v.isSet = true
