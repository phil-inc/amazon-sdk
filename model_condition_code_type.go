...
// ConditionCodeType Enum representing the type of condition code.  `ICD10CM` - International Classification of Diseases, Tenth Revision, Clinical Modification (ICD-10-CM) is a standardized classification system of diagnosis codes that represent conditions and diseases, related health problems, abnormal findings, signs and symptoms, injuries, external causes of injuries and diseases, and social circumstances.
type ConditionCodeType string

// List of ConditionCodeType
const (
	ICD10_CM_1 ConditionCodeType = "ICD10CM"
)

// All allowed values of ConditionCodeType enum
var AllowedConditionCodeTypeEnumValues = []ConditionCodeType{
	"ICD10CM",
}

func (v *ConditionCodeType) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := ConditionCodeType(value)
	for _, existing := range AllowedConditionCodeTypeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid ConditionCodeType", value)
}

// NewConditionCodeTypeFromValue returns a pointer to a valid ConditionCodeType
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewConditionCodeTypeFromValue(v string) (*ConditionCodeType, error) {
	ev := ConditionCodeType(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for ConditionCodeType: valid values are %v", v, AllowedConditionCodeTypeEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v ConditionCodeType) IsValid() bool {
	for _, existing := range AllowedConditionCodeTypeEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to ConditionCodeType value
func (v ConditionCodeType) Ptr() *ConditionCodeType {
	return &v
}

type NullableConditionCodeType struct {
	value *ConditionCodeType
	isSet bool
}

func (v NullableConditionCodeType) Get() *ConditionCodeType {
	return v.value
}

func (v *NullableConditionCodeType) Set(val *ConditionCodeType) {
	v.value = val
	v.isSet = true
}

func (v NullableConditionCodeType) IsSet() bool {
	return v.isSet
}

func (v *NullableConditionCodeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConditionCodeType(val *ConditionCodeType) *NullableConditionCodeType {
	return &NullableConditionCodeType{value: val, isSet: true}
}

func (v NullableConditionCodeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConditionCodeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
