...
// PutOrder400Response struct for PutOrder400Response
type PutOrder400Response struct {
	InvalidInputExceptionResponseContent       *InvalidInputExceptionResponseContent
	PreconditionFailedExceptionResponseContent *PreconditionFailedExceptionResponseContent
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *PutOrder400Response) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into InvalidInputExceptionResponseContent
	err = json.Unmarshal(data, &dst.InvalidInputExceptionResponseContent)
	if err == nil {
		jsonInvalidInputExceptionResponseContent, _ := json.Marshal(dst.InvalidInputExceptionResponseContent)
		if string(jsonInvalidInputExceptionResponseContent) == "{}" { // empty struct
			dst.InvalidInputExceptionResponseContent = nil
		} else {
			return nil // data stored in dst.InvalidInputExceptionResponseContent, return on the first match
		}
	} else {
		dst.InvalidInputExceptionResponseContent = nil
	}

	// try to unmarshal JSON data into PreconditionFailedExceptionResponseContent
	err = json.Unmarshal(data, &dst.PreconditionFailedExceptionResponseContent)
	if err == nil {
		jsonPreconditionFailedExceptionResponseContent, _ := json.Marshal(dst.PreconditionFailedExceptionResponseContent)
		if string(jsonPreconditionFailedExceptionResponseContent) == "{}" { // empty struct
			dst.PreconditionFailedExceptionResponseContent = nil
		} else {
			return nil // data stored in dst.PreconditionFailedExceptionResponseContent, return on the first match
		}
	} else {
		dst.PreconditionFailedExceptionResponseContent = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(PutOrder400Response)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src PutOrder400Response) MarshalJSON() ([]byte, error) {
	if src.InvalidInputExceptionResponseContent != nil {
		return json.Marshal(&src.InvalidInputExceptionResponseContent)
	}

	if src.PreconditionFailedExceptionResponseContent != nil {
		return json.Marshal(&src.PreconditionFailedExceptionResponseContent)
	}

	return nil, nil // no data in anyOf schemas
}

type NullablePutOrder400Response struct {
	value *PutOrder400Response
	isSet bool
}

func (v NullablePutOrder400Response) Get() *PutOrder400Response {
	return v.value
}

func (v *NullablePutOrder400Response) Set(val *PutOrder400Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePutOrder400Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePutOrder400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutOrder400Response(val *PutOrder400Response) *NullablePutOrder400Response {
	return &NullablePutOrder400Response{value: val, isSet: true}
}

func (v NullablePutOrder400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutOrder400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
