...
// checks if the PostPrescriptionTransferRequestContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostPrescriptionTransferRequestContent{}

// PostPrescriptionTransferRequestContent Structure representing the request for transferring a prescription.
type PostPrescriptionTransferRequestContent struct {
	...
	TransferToPharmacy TransferToPharmacy `json:"transferToPharmacy"`
	// The reason for transferring out this prescription.
	ReasonForTransfer *string `json:"reasonForTransfer,omitempty"`
}

type _PostPrescriptionTransferRequestContent PostPrescriptionTransferRequestContent
...
func NewPostPrescriptionTransferRequestContent(partnerPrescriptionId string, transferToPharmacy TransferToPharmacy) *PostPrescriptionTransferRequestContent {
	this := PostPrescriptionTransferRequestContent{}
	this.PartnerPrescriptionId = partnerPrescriptionId
	this.TransferToPharmacy = transferToPharmacy
	return &this
}
...
// GetTransferToPharmacy returns the TransferToPharmacy field value
func (o *PostPrescriptionTransferRequestContent) GetTransferToPharmacy() TransferToPharmacy {
	if o == nil {
		var ret TransferToPharmacy
		return ret
	}

	return o.TransferToPharmacy
}

// GetTransferToPharmacyOk returns a tuple with the TransferToPharmacy field value
// and a boolean to check if the value has been set.
func (o *PostPrescriptionTransferRequestContent) GetTransferToPharmacyOk() (*TransferToPharmacy, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TransferToPharmacy, true
}

// SetTransferToPharmacy sets field value
func (o *PostPrescriptionTransferRequestContent) SetTransferToPharmacy(v TransferToPharmacy) {
	o.TransferToPharmacy = v
}

// GetReasonForTransfer returns the ReasonForTransfer field value if set, zero value otherwise.
func (o *PostPrescriptionTransferRequestContent) GetReasonForTransfer() string {
	if o == nil || IsNil(o.ReasonForTransfer) {
		var ret string
		return ret
	}
	return *o.ReasonForTransfer
}

// GetReasonForTransferOk returns a tuple with the ReasonForTransfer field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PostPrescriptionTransferRequestContent) GetReasonForTransferOk() (*string, bool) {
	if o == nil || IsNil(o.ReasonForTransfer) {
		return nil, false
	}
	return o.ReasonForTransfer, true
}
...
// SetReasonForTransfer gets a reference to the given string and assigns it to the ReasonForTransfer field.
func (o *PostPrescriptionTransferRequestContent) SetReasonForTransfer(v string) {
	o.ReasonForTransfer = &v
}

func (o PostPrescriptionTransferRequestContent) MarshalJSON() ([]byte, error) {
...
func (o PostPrescriptionTransferRequestContent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["partnerPrescriptionId"] = o.PartnerPrescriptionId
	toSerialize["transferToPharmacy"] = o.TransferToPharmacy
	if !IsNil(o.ReasonForTransfer) {
		toSerialize["reasonForTransfer"] = o.ReasonForTransfer
	}
	return toSerialize, nil
}

func (o *PostPrescriptionTransferRequestContent) UnmarshalJSON(data []byte) (err error) {
	...
	varPostPrescriptionTransferRequestContent := _PostPrescriptionTransferRequestContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostPrescriptionTransferRequestContent)

	if err != nil {
		return err
	}

	*o = PostPrescriptionTransferRequestContent(varPostPrescriptionTransferRequestContent)

	return err
}

type NullablePostPrescriptionTransferRequestContent struct {
	value *PostPrescriptionTransferRequestContent
	isSet bool
}

func (v NullablePostPrescriptionTransferRequestContent) Get() *PostPrescriptionTransferRequestContent {
	return v.value
}

func (v *NullablePostPrescriptionTransferRequestContent) Set(val *PostPrescriptionTransferRequestContent) {
	v.value = val
	v.isSet = true
}

func (v NullablePostPrescriptionTransferRequestContent) IsSet() bool {
	return v.isSet
}

func (v *NullablePostPrescriptionTransferRequestContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostPrescriptionTransferRequestContent(val *PostPrescriptionTransferRequestContent) *NullablePostPrescriptionTransferRequestContent {
	return &NullablePostPrescriptionTransferRequestContent{value: val, isSet: true}
}

func (v NullablePostPrescriptionTransferRequestContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostPrescriptionTransferRequestContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
