...
// ClinicalInformationQualifier Qualifies how the PrimaryDiagnosis was obtained.  `1` - Prescriber/Prescriber Supplied - The diagnosis was given or supplied by the prescriber.  `2` - Pharmacy Inferred - The pharmacy inferred the diagnosis using their professional judgment.
type ClinicalInformationQualifier string

// List of ClinicalInformationQualifier
const (
	_1 ClinicalInformationQualifier = "1"
	_2 ClinicalInformationQualifier = "2"
)

// All allowed values of ClinicalInformationQualifier enum
var AllowedClinicalInformationQualifierEnumValues = []ClinicalInformationQualifier{
	"1",
	"2",
}

func (v *ClinicalInformationQualifier) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := ClinicalInformationQualifier(value)
	for _, existing := range AllowedClinicalInformationQualifierEnumValues {
	...
	return fmt.Errorf("%+v is not a valid ClinicalInformationQualifier", value)
}

// NewClinicalInformationQualifierFromValue returns a pointer to a valid ClinicalInformationQualifier
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewClinicalInformationQualifierFromValue(v string) (*ClinicalInformationQualifier, error) {
	ev := ClinicalInformationQualifier(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for ClinicalInformationQualifier: valid values are %v", v, AllowedClinicalInformationQualifierEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v ClinicalInformationQualifier) IsValid() bool {
	for _, existing := range AllowedClinicalInformationQualifierEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to ClinicalInformationQualifier value
func (v ClinicalInformationQualifier) Ptr() *ClinicalInformationQualifier {
	return &v
}

type NullableClinicalInformationQualifier struct {
	value *ClinicalInformationQualifier
	isSet bool
}

func (v NullableClinicalInformationQualifier) Get() *ClinicalInformationQualifier {
	return v.value
}

func (v *NullableClinicalInformationQualifier) Set(val *ClinicalInformationQualifier) {
	v.value = val
	v.isSet = true
}

func (v NullableClinicalInformationQualifier) IsSet() bool {
	return v.isSet
}

func (v *NullableClinicalInformationQualifier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClinicalInformationQualifier(val *ClinicalInformationQualifier) *NullableClinicalInformationQualifier {
	return &NullableClinicalInformationQualifier{value: val, isSet: true}
}

func (v NullableClinicalInformationQualifier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClinicalInformationQualifier) UnmarshalJSON(src []byte) error {
	v.isSet = true
