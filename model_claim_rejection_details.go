...
// checks if the ClaimRejectionDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClaimRejectionDetails{}

// ClaimRejectionDetails Structure representing Claim rejected details for an order failure due to claim rejection
type ClaimRejectionDetails struct {
	// This field represents reasons for claim rejections
	ClaimRejectionReasons []ClaimRejectionReason `json:"claimRejectionReasons,omitempty"`
}
...
// GetClaimRejectionReasons returns the ClaimRejectionReasons field value if set, zero value otherwise.
func (o *ClaimRejectionDetails) GetClaimRejectionReasons() []ClaimRejectionReason {
	if o == nil || IsNil(o.ClaimRejectionReasons) {
		var ret []ClaimRejectionReason
		return ret
	}
	return o.ClaimRejectionReasons
}

// GetClaimRejectionReasonsOk returns a tuple with the ClaimRejectionReasons field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClaimRejectionDetails) GetClaimRejectionReasonsOk() ([]ClaimRejectionReason, bool) {
	if o == nil || IsNil(o.ClaimRejectionReasons) {
		return nil, false
	}
	return o.ClaimRejectionReasons, true
}
...
// SetClaimRejectionReasons gets a reference to the given []ClaimRejectionReason and assigns it to the ClaimRejectionReasons field.
func (o *ClaimRejectionDetails) SetClaimRejectionReasons(v []ClaimRejectionReason) {
	o.ClaimRejectionReasons = v
}

func (o ClaimRejectionDetails) MarshalJSON() ([]byte, error) {
...
func (o ClaimRejectionDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ClaimRejectionReasons) {
		toSerialize["claimRejectionReasons"] = o.ClaimRejectionReasons
	}
	return toSerialize, nil
}

type NullableClaimRejectionDetails struct {
	value *ClaimRejectionDetails
	isSet bool
}

func (v NullableClaimRejectionDetails) Get() *ClaimRejectionDetails {
	return v.value
}

func (v *NullableClaimRejectionDetails) Set(val *ClaimRejectionDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableClaimRejectionDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableClaimRejectionDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClaimRejectionDetails(val *ClaimRejectionDetails) *NullableClaimRejectionDetails {
	return &NullableClaimRejectionDetails{value: val, isSet: true}
}

func (v NullableClaimRejectionDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClaimRejectionDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
