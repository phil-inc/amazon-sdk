...
// checks if the PreconditionFailedExceptionResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PreconditionFailedExceptionResponseContent{}

// PreconditionFailedExceptionResponseContent This exception is thrown when precondition validation failed for the request.
type PreconditionFailedExceptionResponseContent struct {
	// A human-readable message describing the precondition failure exception describing the precondition failure exception that was caught by the Amazon Pharmacy APIs
	Message string `json:"message" validate:"regexp=^\\\\s*\\\\S.*$"`
	ErrorCode PreconditionErrorCode `json:"errorCode"`
	// List of fields responsible for the error, if applicable.
	ErrorFieldList []ErrorField `json:"errorFieldList,omitempty"`
}

type _PreconditionFailedExceptionResponseContent PreconditionFailedExceptionResponseContent
...
func NewPreconditionFailedExceptionResponseContent(message string, errorCode PreconditionErrorCode) *PreconditionFailedExceptionResponseContent {
	this := PreconditionFailedExceptionResponseContent{}
...
func (o PreconditionFailedExceptionResponseContent) MarshalJSON() ([]byte, error) {
...
func (o PreconditionFailedExceptionResponseContent) ToMap() (map[string]interface{}, error) {
...
func (o *PreconditionFailedExceptionResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varPreconditionFailedExceptionResponseContent := _PreconditionFailedExceptionResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPreconditionFailedExceptionResponseContent)

	if err != nil {
		return err
	}

	*o = PreconditionFailedExceptionResponseContent(varPreconditionFailedExceptionResponseContent)

	return err
}

type NullablePreconditionFailedExceptionResponseContent struct {
	value *PreconditionFailedExceptionResponseContent
	isSet bool
}

func (v NullablePreconditionFailedExceptionResponseContent) Get() *PreconditionFailedExceptionResponseContent {
	return v.value
}

func (v *NullablePreconditionFailedExceptionResponseContent) Set(val *PreconditionFailedExceptionResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullablePreconditionFailedExceptionResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullablePreconditionFailedExceptionResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePreconditionFailedExceptionResponseContent(val *PreconditionFailedExceptionResponseContent) *NullablePreconditionFailedExceptionResponseContent {
	return &NullablePreconditionFailedExceptionResponseContent{value: val, isSet: true}
}

func (v NullablePreconditionFailedExceptionResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePreconditionFailedExceptionResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
