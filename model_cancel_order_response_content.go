...
// checks if the CancelOrderResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelOrderResponseContent{}

// CancelOrderResponseContent Structure representing the response for cancelling an order.
type CancelOrderResponseContent struct {
	// The unique Order identifier provided during the creation of the order.
	PartnerOrderId string `json:"partnerOrderId" validate:"regexp=^[0-9a-zA-Z-]{1,40}$"`
}

type _CancelOrderResponseContent CancelOrderResponseContent
...
func NewCancelOrderResponseContent(partnerOrderId string) *CancelOrderResponseContent {
	this := CancelOrderResponseContent{}
...
func (o CancelOrderResponseContent) MarshalJSON() ([]byte, error) {
...
func (o CancelOrderResponseContent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["partnerOrderId"] = o.PartnerOrderId
	return toSerialize, nil
}

func (o *CancelOrderResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varCancelOrderResponseContent := _CancelOrderResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCancelOrderResponseContent)

	if err != nil {
		return err
	}

	*o = CancelOrderResponseContent(varCancelOrderResponseContent)

	return err
}

type NullableCancelOrderResponseContent struct {
	value *CancelOrderResponseContent
	isSet bool
}

func (v NullableCancelOrderResponseContent) Get() *CancelOrderResponseContent {
	return v.value
}

func (v *NullableCancelOrderResponseContent) Set(val *CancelOrderResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelOrderResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelOrderResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelOrderResponseContent(val *CancelOrderResponseContent) *NullableCancelOrderResponseContent {
	return &NullableCancelOrderResponseContent{value: val, isSet: true}
}

func (v NullableCancelOrderResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelOrderResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
