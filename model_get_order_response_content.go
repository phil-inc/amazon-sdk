...
// checks if the GetOrderResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOrderResponseContent{}

// GetOrderResponseContent Structure representing the response for getting an order.
type GetOrderResponseContent struct {
	Order Order `json:"order"`
}

type _GetOrderResponseContent GetOrderResponseContent
...
func (o GetOrderResponseContent) MarshalJSON() ([]byte, error) {
...
func (o GetOrderResponseContent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["order"] = o.Order
	return toSerialize, nil
}

func (o *GetOrderResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varGetOrderResponseContent := _GetOrderResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetOrderResponseContent)

	if err != nil {
		return err
	}

	*o = GetOrderResponseContent(varGetOrderResponseContent)

	return err
}

type NullableGetOrderResponseContent struct {
	value *GetOrderResponseContent
	isSet bool
}

func (v NullableGetOrderResponseContent) Get() *GetOrderResponseContent {
	return v.value
}

func (v *NullableGetOrderResponseContent) Set(val *GetOrderResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOrderResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOrderResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOrderResponseContent(val *GetOrderResponseContent) *NullableGetOrderResponseContent {
	return &NullableGetOrderResponseContent{value: val, isSet: true}
}

func (v NullableGetOrderResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOrderResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
