...
// VitalSign Specifies the type of vital sign measurement
type VitalSign string
...
// All allowed values of VitalSign enum
var AllowedVitalSignEnumValues = []VitalSign{
	"HEIGHT",
	"WEIGHT",
}

func (v *VitalSign) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := VitalSign(value)
	for _, existing := range AllowedVitalSignEnumValues {
	...
	return fmt.Errorf("%+v is not a valid VitalSign", value)
}

// NewVitalSignFromValue returns a pointer to a valid VitalSign
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewVitalSignFromValue(v string) (*VitalSign, error) {
	ev := VitalSign(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for VitalSign: valid values are %v", v, AllowedVitalSignEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v VitalSign) IsValid() bool {
	for _, existing := range AllowedVitalSignEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to VitalSign value
func (v VitalSign) Ptr() *VitalSign {
	return &v
}

type NullableVitalSign struct {
	value *VitalSign
	isSet bool
}

func (v NullableVitalSign) Get() *VitalSign {
	return v.value
}

func (v *NullableVitalSign) Set(val *VitalSign) {
	v.value = val
	v.isSet = true
}

func (v NullableVitalSign) IsSet() bool {
	return v.isSet
}

func (v *NullableVitalSign) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVitalSign(val *VitalSign) *NullableVitalSign {
	return &NullableVitalSign{value: val, isSet: true}
}

func (v NullableVitalSign) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVitalSign) UnmarshalJSON(src []byte) error {
	v.isSet = true
