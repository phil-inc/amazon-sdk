...
type Measurement struct {
	...
	// The empirical value of the vital sign observed
	Value string `json:"value" validate:"regexp=^([!-~]|[ ])*[!-~]([!-~]|[ ])*$"`
	// The unit of measurement for the vital sign (e.g., kg, cm)
	MeasurementUnitOfMeasure string `json:"measurementUnitOfMeasure" validate:"regexp=^([!-~]|[ ])*[!-~]([!-~]|[ ])*$"`
	// Date on which observation was recorded
	ObservationDate string `json:"observationDate" validate:"regexp=^\\\\d{4}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$"`
}
...
func NewMeasurement(vitalSign VitalSign, value string, measurementUnitOfMeasure string, observationDate string) *Measurement {
	...
	this.Value = value
	this.MeasurementUnitOfMeasure = measurementUnitOfMeasure
...
// GetVitalSign returns the VitalSign field value
...
// GetVitalSignOk returns a tuple with the VitalSign field value
// and a boolean to check if the value has been set.
func (o *Measurement) GetVitalSignOk() (*VitalSign, bool) {
	if o == nil {
		return nil, false
	}
	return &o.VitalSign, true
}

// SetVitalSign sets field value
...
// GetMeasurementUnitOfMeasure returns the MeasurementUnitOfMeasure field value
func (o *Measurement) GetMeasurementUnitOfMeasure() string {
	...
	return o.MeasurementUnitOfMeasure
}

// GetMeasurementUnitOfMeasureOk returns a tuple with the MeasurementUnitOfMeasure field value
// and a boolean to check if the value has been set.
func (o *Measurement) GetMeasurementUnitOfMeasureOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.MeasurementUnitOfMeasure, true
}

// SetMeasurementUnitOfMeasure sets field value
func (o *Measurement) SetMeasurementUnitOfMeasure(v string) {
	o.MeasurementUnitOfMeasure = v
}

// GetObservationDate returns the ObservationDate field value
func (o *Measurement) GetObservationDate() string {
	...
	return o.ObservationDate
}

// GetObservationDateOk returns a tuple with the ObservationDate field value
// and a boolean to check if the value has been set.
func (o *Measurement) GetObservationDateOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ObservationDate, true
}

// SetObservationDate sets field value
...
func (o Measurement) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["vitalSign"] = o.VitalSign
	toSerialize["value"] = o.Value
	toSerialize["measurementUnitOfMeasure"] = o.MeasurementUnitOfMeasure
	toSerialize["observationDate"] = o.ObservationDate
