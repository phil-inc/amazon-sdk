...
// checks if the MedicalDiagnosis type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MedicalDiagnosis{}

// MedicalDiagnosis struct for MedicalDiagnosis
type MedicalDiagnosis struct {
	ClinicalInformationQualifier ClinicalInformationQualifier `json:"clinicalInformationQualifier"`
	Primary DiagnosisCode `json:"primary"`
	Secondary *DiagnosisCode `json:"secondary,omitempty"`
}

type _MedicalDiagnosis MedicalDiagnosis
...
// GetClinicalInformationQualifier returns the ClinicalInformationQualifier field value
func (o *MedicalDiagnosis) GetClinicalInformationQualifier() ClinicalInformationQualifier {
	if o == nil {
		var ret ClinicalInformationQualifier
		return ret
	}

	return o.ClinicalInformationQualifier
}

// GetClinicalInformationQualifierOk returns a tuple with the ClinicalInformationQualifier field value
// and a boolean to check if the value has been set.
func (o *MedicalDiagnosis) GetClinicalInformationQualifierOk() (*ClinicalInformationQualifier, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ClinicalInformationQualifier, true
}

// SetClinicalInformationQualifier sets field value
func (o *MedicalDiagnosis) SetClinicalInformationQualifier(v ClinicalInformationQualifier) {
	o.ClinicalInformationQualifier = v
}

// GetPrimary returns the Primary field value
func (o *MedicalDiagnosis) GetPrimary() DiagnosisCode {
	if o == nil {
		var ret DiagnosisCode
		return ret
	}
...
// SetSecondary gets a reference to the given DiagnosisCode and assigns it to the Secondary field.
func (o *MedicalDiagnosis) SetSecondary(v DiagnosisCode) {
	o.Secondary = &v
}

func (o MedicalDiagnosis) MarshalJSON() ([]byte, error) {
...
func (o MedicalDiagnosis) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["clinicalInformationQualifier"] = o.ClinicalInformationQualifier
...
func (o *MedicalDiagnosis) UnmarshalJSON(data []byte) (err error) {
	...
	varMedicalDiagnosis := _MedicalDiagnosis{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMedicalDiagnosis)

	if err != nil {
		return err
	}

	*o = MedicalDiagnosis(varMedicalDiagnosis)

	return err
}

type NullableMedicalDiagnosis struct {
	value *MedicalDiagnosis
	isSet bool
}

func (v NullableMedicalDiagnosis) Get() *MedicalDiagnosis {
	return v.value
}

func (v *NullableMedicalDiagnosis) Set(val *MedicalDiagnosis) {
	v.value = val
	v.isSet = true
}

func (v NullableMedicalDiagnosis) IsSet() bool {
	return v.isSet
}

func (v *NullableMedicalDiagnosis) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMedicalDiagnosis(val *MedicalDiagnosis) *NullableMedicalDiagnosis {
	return &NullableMedicalDiagnosis{value: val, isSet: true}
}

func (v NullableMedicalDiagnosis) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMedicalDiagnosis) UnmarshalJSON(src []byte) error {
	v.isSet = true
