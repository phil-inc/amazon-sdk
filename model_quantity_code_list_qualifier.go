...
// QuantityCodeListQualifier Qualifies the different types of QuantityValue.  `38` - Original Quantity  `40` - Remaining Quantity  `87` - Quantity Received  `QS` - Quantity sufficient as determined by the dispensing pharmacy. Quantity to be based on established dispensing protocols between the prescriber and pharmacy/pharmacist.  `CF` - Compound Final Quantity  `UQ` - Central Fill Unit of Use Quantity  `QT` - Quantity Transferred
type QuantityCodeListQualifier string

// List of QuantityCodeListQualifier
const (
	_38 QuantityCodeListQualifier = "38"
	_40 QuantityCodeListQualifier = "40"
	_87 QuantityCodeListQualifier = "87"
	QS QuantityCodeListQualifier = "QS"
	CF QuantityCodeListQualifier = "CF"
	UQ QuantityCodeListQualifier = "UQ"
	QT QuantityCodeListQualifier = "QT"
)

// All allowed values of QuantityCodeListQualifier enum
var AllowedQuantityCodeListQualifierEnumValues = []QuantityCodeListQualifier{
	"38",
	"40",
	"87",
	"QS",
...
func (v *QuantityCodeListQualifier) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := QuantityCodeListQualifier(value)
	for _, existing := range AllowedQuantityCodeListQualifierEnumValues {
	...
	return fmt.Errorf("%+v is not a valid QuantityCodeListQualifier", value)
}

// NewQuantityCodeListQualifierFromValue returns a pointer to a valid QuantityCodeListQualifier
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewQuantityCodeListQualifierFromValue(v string) (*QuantityCodeListQualifier, error) {
	ev := QuantityCodeListQualifier(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for QuantityCodeListQualifier: valid values are %v", v, AllowedQuantityCodeListQualifierEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v QuantityCodeListQualifier) IsValid() bool {
	for _, existing := range AllowedQuantityCodeListQualifierEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to QuantityCodeListQualifier value
func (v QuantityCodeListQualifier) Ptr() *QuantityCodeListQualifier {
	return &v
}

type NullableQuantityCodeListQualifier struct {
	value *QuantityCodeListQualifier
	isSet bool
}

func (v NullableQuantityCodeListQualifier) Get() *QuantityCodeListQualifier {
	return v.value
}

func (v *NullableQuantityCodeListQualifier) Set(val *QuantityCodeListQualifier) {
	v.value = val
	v.isSet = true
}

func (v NullableQuantityCodeListQualifier) IsSet() bool {
	return v.isSet
}

func (v *NullableQuantityCodeListQualifier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuantityCodeListQualifier(val *QuantityCodeListQualifier) *NullableQuantityCodeListQualifier {
	return &NullableQuantityCodeListQualifier{value: val, isSet: true}
}

func (v NullableQuantityCodeListQualifier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuantityCodeListQualifier) UnmarshalJSON(src []byte) error {
	v.isSet = true
