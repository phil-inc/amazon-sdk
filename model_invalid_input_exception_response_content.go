...
// checks if the InvalidInputExceptionResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvalidInputExceptionResponseContent{}

// InvalidInputExceptionResponseContent This exception is thrown on receiving an invalid request which cannot be processed by the service. The server cannot or will not process the request due to something that is perceived to be a client error.
type InvalidInputExceptionResponseContent struct {
	// A human-readable message describing the invalid input exception. Usually this is due to invalid or out-of-range value was supplied for an input parameter
	Message   string                 `json:"message" validate:"regexp=^\\\\s*\\\\S.*$"`
	ErrorCode *InvalidInputErrorCode `json:"errorCode,omitempty"`
	// List of fields responsible for the error, if applicable.
	ErrorFieldList []ErrorField `json:"errorFieldList,omitempty"`
}

type _InvalidInputExceptionResponseContent InvalidInputExceptionResponseContent
...
func NewInvalidInputExceptionResponseContent(message string) *InvalidInputExceptionResponseContent {
	this := InvalidInputExceptionResponseContent{}
...
// SetErrorCode gets a reference to the given InvalidInputErrorCode and assigns it to the ErrorCode field.
func (o *InvalidInputExceptionResponseContent) SetErrorCode(v InvalidInputErrorCode) {
	o.ErrorCode = &v
}

// GetErrorFieldList returns the ErrorFieldList field value if set, zero value otherwise.
func (o *InvalidInputExceptionResponseContent) GetErrorFieldList() []ErrorField {
	if o == nil || IsNil(o.ErrorFieldList) {
		var ret []ErrorField
		return ret
	}
	return o.ErrorFieldList
}

// GetErrorFieldListOk returns a tuple with the ErrorFieldList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InvalidInputExceptionResponseContent) GetErrorFieldListOk() ([]ErrorField, bool) {
	if o == nil || IsNil(o.ErrorFieldList) {
		return nil, false
	}
	return o.ErrorFieldList, true
}
...
// SetErrorFieldList gets a reference to the given []ErrorField and assigns it to the ErrorFieldList field.
func (o *InvalidInputExceptionResponseContent) SetErrorFieldList(v []ErrorField) {
	o.ErrorFieldList = v
}

func (o InvalidInputExceptionResponseContent) MarshalJSON() ([]byte, error) {
...
func (o InvalidInputExceptionResponseContent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["message"] = o.Message
	if !IsNil(o.ErrorCode) {
		toSerialize["errorCode"] = o.ErrorCode
	}
	if !IsNil(o.ErrorFieldList) {
		toSerialize["errorFieldList"] = o.ErrorFieldList
	}
	return toSerialize, nil
}

func (o *InvalidInputExceptionResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varInvalidInputExceptionResponseContent := _InvalidInputExceptionResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInvalidInputExceptionResponseContent)

	if err != nil {
		return err
	}

	*o = InvalidInputExceptionResponseContent(varInvalidInputExceptionResponseContent)

	return err
}

type NullableInvalidInputExceptionResponseContent struct {
	value *InvalidInputExceptionResponseContent
	isSet bool
}

func (v NullableInvalidInputExceptionResponseContent) Get() *InvalidInputExceptionResponseContent {
	return v.value
}

func (v *NullableInvalidInputExceptionResponseContent) Set(val *InvalidInputExceptionResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullableInvalidInputExceptionResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullableInvalidInputExceptionResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvalidInputExceptionResponseContent(val *InvalidInputExceptionResponseContent) *NullableInvalidInputExceptionResponseContent {
	return &NullableInvalidInputExceptionResponseContent{value: val, isSet: true}
}

func (v NullableInvalidInputExceptionResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvalidInputExceptionResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
