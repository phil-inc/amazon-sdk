...
// checks if the PrescriptionTransferInDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrescriptionTransferInDetails{}

// PrescriptionTransferInDetails Structure containing transfer details when a prescription is transferred from a pharmacy to Amazon Pharmacy, regardless of whether sending pharmacy is dispensing or non-dispensing pharmacy.  Required: Only for pharmacy-to-pharmacy transfers Optional: When prescription comes directly from a prescriber  This structure captures: - Sending pharmacy information (identification, contact details) - Transfer-specific data (fill history, remaining refills, quantities)  Do not include this structure for prescriber-direct prescriptions.
type PrescriptionTransferInDetails struct {
	SendingPharmacy Pharmacy `json:"sendingPharmacy"`
	PrescriptionTransferred PrescriptionTransferred `json:"prescriptionTransferred"`
}

type _PrescriptionTransferInDetails PrescriptionTransferInDetails
...
func NewPrescriptionTransferInDetails(sendingPharmacy Pharmacy, prescriptionTransferred PrescriptionTransferred) *PrescriptionTransferInDetails {
	this := PrescriptionTransferInDetails{}
	this.SendingPharmacy = sendingPharmacy
	this.PrescriptionTransferred = prescriptionTransferred
	return &this
}
...
// GetSendingPharmacy returns the SendingPharmacy field value
...
// GetSendingPharmacyOk returns a tuple with the SendingPharmacy field value
...
// SetSendingPharmacy sets field value
func (o *PrescriptionTransferInDetails) SetSendingPharmacy(v Pharmacy) {
	o.SendingPharmacy = v
}

// GetPrescriptionTransferred returns the PrescriptionTransferred field value
func (o *PrescriptionTransferInDetails) GetPrescriptionTransferred() PrescriptionTransferred {
	if o == nil {
		var ret PrescriptionTransferred
		return ret
	}

	return o.PrescriptionTransferred
}

// GetPrescriptionTransferredOk returns a tuple with the PrescriptionTransferred field value
// and a boolean to check if the value has been set.
func (o *PrescriptionTransferInDetails) GetPrescriptionTransferredOk() (*PrescriptionTransferred, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PrescriptionTransferred, true
}

// SetPrescriptionTransferred sets field value
func (o *PrescriptionTransferInDetails) SetPrescriptionTransferred(v PrescriptionTransferred) {
	o.PrescriptionTransferred = v
}

func (o PrescriptionTransferInDetails) MarshalJSON() ([]byte, error) {
...
func (o PrescriptionTransferInDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["sendingPharmacy"] = o.SendingPharmacy
	toSerialize["prescriptionTransferred"] = o.PrescriptionTransferred
	return toSerialize, nil
}

func (o *PrescriptionTransferInDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varPrescriptionTransferInDetails := _PrescriptionTransferInDetails{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPrescriptionTransferInDetails)

	if err != nil {
		return err
	}

	*o = PrescriptionTransferInDetails(varPrescriptionTransferInDetails)

	return err
}

type NullablePrescriptionTransferInDetails struct {
	value *PrescriptionTransferInDetails
	isSet bool
}

func (v NullablePrescriptionTransferInDetails) Get() *PrescriptionTransferInDetails {
	return v.value
}

func (v *NullablePrescriptionTransferInDetails) Set(val *PrescriptionTransferInDetails) {
	v.value = val
	v.isSet = true
}

func (v NullablePrescriptionTransferInDetails) IsSet() bool {
	return v.isSet
}

func (v *NullablePrescriptionTransferInDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrescriptionTransferInDetails(val *PrescriptionTransferInDetails) *NullablePrescriptionTransferInDetails {
	return &NullablePrescriptionTransferInDetails{value: val, isSet: true}
}

func (v NullablePrescriptionTransferInDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrescriptionTransferInDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
