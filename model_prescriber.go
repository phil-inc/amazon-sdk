...
// checks if the Prescriber type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Prescriber{}

// Prescriber Structure representing the prescriber details.
type Prescriber struct {
	// A National Provider System (NPS) assigned identifier for the prescriber.
	Npi string `json:"npi" validate:"regexp=^\\\\s*\\\\S.*$"`
	PrescriberName Name `json:"prescriberName"`
	PrescriberAddress Address `json:"prescriberAddress"`
	// The primary telephone number of the prescriber.
	PrimaryTelephone string `json:"primaryTelephone" validate:"regexp=^1?[2-9]\\\\d{2}[2-9]\\\\d{6}$"`
	// The Drug Enforcement Administration (DEA) assigned number to the prescriber.
	DeaNumber *string `json:"deaNumber,omitempty" validate:"regexp=^\\\\s*\\\\S.*$"`
	// The prescriber's state license number.
	StateLicenseNumber *string `json:"stateLicenseNumber,omitempty" validate:"regexp=^\\\\s*\\\\S.*$"`
	// The business name associated with the prescriber.
	BusinessName *string `json:"businessName,omitempty" validate:"regexp=^\\\\s*\\\\S.*$"`
	// The fax number of the prescriber.
	Fax *string `json:"fax,omitempty" validate:"regexp=^1?[2-9]\\\\d{2}[2-9]\\\\d{6}$"`
}

type _Prescriber Prescriber
...
// GetPrescriberAddress returns the PrescriberAddress field value
func (o *Prescriber) GetPrescriberAddress() Address {
	...
	return o.PrescriberAddress
}

// GetPrescriberAddressOk returns a tuple with the PrescriberAddress field value
// and a boolean to check if the value has been set.
func (o *Prescriber) GetPrescriberAddressOk() (*Address, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PrescriberAddress, true
}

// SetPrescriberAddress sets field value
func (o *Prescriber) SetPrescriberAddress(v Address) {
	o.PrescriberAddress = v
}
...
// GetStateLicenseNumber returns the StateLicenseNumber field value if set, zero value otherwise.
func (o *Prescriber) GetStateLicenseNumber() string {
	if o == nil || IsNil(o.StateLicenseNumber) {
		var ret string
		return ret
	}
	return *o.StateLicenseNumber
}

// GetStateLicenseNumberOk returns a tuple with the StateLicenseNumber field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Prescriber) GetStateLicenseNumberOk() (*string, bool) {
	if o == nil || IsNil(o.StateLicenseNumber) {
		return nil, false
	}
	return o.StateLicenseNumber, true
}
...
// SetStateLicenseNumber gets a reference to the given string and assigns it to the StateLicenseNumber field.
func (o *Prescriber) SetStateLicenseNumber(v string) {
	o.StateLicenseNumber = &v
}
...
func (o Prescriber) MarshalJSON() ([]byte, error) {
...
func (o Prescriber) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["npi"] = o.Npi
	toSerialize["prescriberName"] = o.PrescriberName
	toSerialize["prescriberAddress"] = o.PrescriberAddress
	toSerialize["primaryTelephone"] = o.PrimaryTelephone
	if !IsNil(o.DeaNumber) {
		toSerialize["deaNumber"] = o.DeaNumber
	}
	if !IsNil(o.StateLicenseNumber) {
		toSerialize["stateLicenseNumber"] = o.StateLicenseNumber
	}
...
func (o *Prescriber) UnmarshalJSON(data []byte) (err error) {
	...
	varPrescriber := _Prescriber{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPrescriber)

	if err != nil {
		return err
	}

	*o = Prescriber(varPrescriber)

	return err
}

type NullablePrescriber struct {
	value *Prescriber
	isSet bool
}

func (v NullablePrescriber) Get() *Prescriber {
	return v.value
}

func (v *NullablePrescriber) Set(val *Prescriber) {
	v.value = val
	v.isSet = true
}

func (v NullablePrescriber) IsSet() bool {
	return v.isSet
}

func (v *NullablePrescriber) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrescriber(val *Prescriber) *NullablePrescriber {
	return &NullablePrescriber{value: val, isSet: true}
}

func (v NullablePrescriber) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrescriber) UnmarshalJSON(src []byte) error {
	v.isSet = true
