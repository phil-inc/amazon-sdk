...
// PossibleInsuranceFieldsInError This represents Enums of possible insurance fields in error.     `BIN` - A 6-digit number that identifies the Pharmacy Benefit Manager (PBM) that this insurance uses for pharmacy claims.     `PCN` - Processor Control Number assigned by the processor. PBMs use it to distinguish between plans.     It's a secondary identifier used in addition to the binNumber.     `GROUP_NUMBER` -  The insurance group number found on the insurance card that signifies which group the cardholder belongs to.     `CARDHOLDER_ID` -  The cardholder ID on an insurance card is an unique number that identifies the cardholder to the insurance company.
type PossibleInsuranceFieldsInError string

// List of PossibleInsuranceFieldsInError
const (
	BIN PossibleInsuranceFieldsInError = "BIN"
	CARDHOLDER_ID PossibleInsuranceFieldsInError = "CARDHOLDER_ID"
	GROUP_NUMBER PossibleInsuranceFieldsInError = "GROUP_NUMBER"
	PCN PossibleInsuranceFieldsInError = "PCN"
)

// All allowed values of PossibleInsuranceFieldsInError enum
var AllowedPossibleInsuranceFieldsInErrorEnumValues = []PossibleInsuranceFieldsInError{
	"BIN",
	"CARDHOLDER_ID",
	"GROUP_NUMBER",
	"PCN",
...
func (v *PossibleInsuranceFieldsInError) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PossibleInsuranceFieldsInError(value)
	for _, existing := range AllowedPossibleInsuranceFieldsInErrorEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PossibleInsuranceFieldsInError", value)
}

// NewPossibleInsuranceFieldsInErrorFromValue returns a pointer to a valid PossibleInsuranceFieldsInError
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPossibleInsuranceFieldsInErrorFromValue(v string) (*PossibleInsuranceFieldsInError, error) {
	ev := PossibleInsuranceFieldsInError(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PossibleInsuranceFieldsInError: valid values are %v", v, AllowedPossibleInsuranceFieldsInErrorEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PossibleInsuranceFieldsInError) IsValid() bool {
	for _, existing := range AllowedPossibleInsuranceFieldsInErrorEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PossibleInsuranceFieldsInError value
func (v PossibleInsuranceFieldsInError) Ptr() *PossibleInsuranceFieldsInError {
	return &v
}

type NullablePossibleInsuranceFieldsInError struct {
	value *PossibleInsuranceFieldsInError
	isSet bool
}

func (v NullablePossibleInsuranceFieldsInError) Get() *PossibleInsuranceFieldsInError {
	return v.value
}

func (v *NullablePossibleInsuranceFieldsInError) Set(val *PossibleInsuranceFieldsInError) {
	v.value = val
	v.isSet = true
}

func (v NullablePossibleInsuranceFieldsInError) IsSet() bool {
	return v.isSet
}

func (v *NullablePossibleInsuranceFieldsInError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePossibleInsuranceFieldsInError(val *PossibleInsuranceFieldsInError) *NullablePossibleInsuranceFieldsInError {
	return &NullablePossibleInsuranceFieldsInError{value: val, isSet: true}
}

func (v NullablePossibleInsuranceFieldsInError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePossibleInsuranceFieldsInError) UnmarshalJSON(src []byte) error {
	v.isSet = true
