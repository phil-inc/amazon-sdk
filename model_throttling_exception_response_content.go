...
// ThrottlingExceptionResponseContent This exception is thrown when the user has sent too many requests in a given amount of time.
type ThrottlingExceptionResponseContent struct {
	// A human-readable message describing the throttling exception.
...
func (o ThrottlingExceptionResponseContent) MarshalJSON() ([]byte, error) {
...
func (o *ThrottlingExceptionResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varThrottlingExceptionResponseContent := _ThrottlingExceptionResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varThrottlingExceptionResponseContent)

	if err != nil {
		return err
	}

	*o = ThrottlingExceptionResponseContent(varThrottlingExceptionResponseContent)
