...
type DiagnosisCode struct {
	// International Classification of Diseases (ICD 10) Code of the diagnosis.
	Icd10Code string `json:"icd10Code" validate:"regexp=^[A-TV-Za-tv-z][0-9][0-9ABab](?:\\\\.[0-9A-KXZa-kxz](?:[0-9A-EXYZa-exyz](?:[0-9A-HXa-hx][0-59A-HJKMNP-Sa-hjkmnp-s]?)?)?)?|U07(?:\\\\.[01])?$"`
...
// GetIcd10Code returns the Icd10Code field value
...
// GetIcd10CodeOk returns a tuple with the Icd10Code field value
