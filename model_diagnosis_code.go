...
// checks if the DiagnosisCode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiagnosisCode{}

// DiagnosisCode struct for DiagnosisCode
type DiagnosisCode struct {
	// International Classification of Diseases (ICD 10) Code of the diagnosis. Required for Hubs partners. Not required if codeWithQualifier is passed in.
	Icd10Code         *string                     `json:"icd10Code,omitempty" validate:"regexp=^[A-TV-Za-tv-z][0-9][0-9ABab](?:\\\\.[0-9A-KXZa-kxz](?:[0-9A-EXYZa-exyz](?:[0-9A-HXa-hx][0-59A-HJKMNP-Sa-hjkmnp-s]?)?)?)?|U07(?:\\\\.[01])?$"`
	CodeWithQualifier *DiagnosisCodeWithQualifier `json:"codeWithQualifier,omitempty"`
...
type _DiagnosisCode DiagnosisCode
...
// GetIcd10Code returns the Icd10Code field value if set, zero value otherwise.
func (o *DiagnosisCode) GetIcd10Code() string {
	if o == nil || IsNil(o.Icd10Code) {
		var ret string
		return ret
	}
	return *o.Icd10Code
...
// GetIcd10CodeOk returns a tuple with the Icd10Code field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DiagnosisCode) GetIcd10CodeOk() (*string, bool) {
	if o == nil || IsNil(o.Icd10Code) {
		return nil, false
	}
	return o.Icd10Code, true
}
...
// SetIcd10Code gets a reference to the given string and assigns it to the Icd10Code field.
func (o *DiagnosisCode) SetIcd10Code(v string) {
	o.Icd10Code = &v
}

// GetCodeWithQualifier returns the CodeWithQualifier field value if set, zero value otherwise.
func (o *DiagnosisCode) GetCodeWithQualifier() DiagnosisCodeWithQualifier {
	if o == nil || IsNil(o.CodeWithQualifier) {
		var ret DiagnosisCodeWithQualifier
		return ret
	}
	return *o.CodeWithQualifier
}

// GetCodeWithQualifierOk returns a tuple with the CodeWithQualifier field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DiagnosisCode) GetCodeWithQualifierOk() (*DiagnosisCodeWithQualifier, bool) {
	if o == nil || IsNil(o.CodeWithQualifier) {
		return nil, false
	}
	return o.CodeWithQualifier, true
}
...
// SetCodeWithQualifier gets a reference to the given DiagnosisCodeWithQualifier and assigns it to the CodeWithQualifier field.
func (o *DiagnosisCode) SetCodeWithQualifier(v DiagnosisCodeWithQualifier) {
	o.CodeWithQualifier = &v
}
...
func (o DiagnosisCode) MarshalJSON() ([]byte, error) {
...
func (o DiagnosisCode) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Icd10Code) {
		toSerialize["icd10Code"] = o.Icd10Code
	}
	if !IsNil(o.CodeWithQualifier) {
		toSerialize["codeWithQualifier"] = o.CodeWithQualifier
	}
	toSerialize["description"] = o.Description
	return toSerialize, nil
}

func (o *DiagnosisCode) UnmarshalJSON(data []byte) (err error) {
	...
	varDiagnosisCode := _DiagnosisCode{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDiagnosisCode)

	if err != nil {
		return err
	}

	*o = DiagnosisCode(varDiagnosisCode)

	return err
}

type NullableDiagnosisCode struct {
	value *DiagnosisCode
	isSet bool
}

func (v NullableDiagnosisCode) Get() *DiagnosisCode {
	return v.value
}

func (v *NullableDiagnosisCode) Set(val *DiagnosisCode) {
	v.value = val
	v.isSet = true
}

func (v NullableDiagnosisCode) IsSet() bool {
	return v.isSet
}

func (v *NullableDiagnosisCode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiagnosisCode(val *DiagnosisCode) *NullableDiagnosisCode {
	return &NullableDiagnosisCode{value: val, isSet: true}
}

func (v NullableDiagnosisCode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiagnosisCode) UnmarshalJSON(src []byte) error {
	v.isSet = true
