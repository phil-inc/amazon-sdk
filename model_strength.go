...
// checks if the Strength type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Strength{}

// Strength Structure representing the strength of a medication.
type Strength struct {
	// Dosage Strength, e.g., 120.
	Value *string `json:"value,omitempty" validate:"regexp=^\\\\s*\\\\S.*$"`
	// NCI Code that specifies the strength form code, e.g., C42998. This shape is deprecated: This field will be replaced by `strengthFormCode`. This field will no longer be supported starting from 2025-03-12.
	// Deprecated
	FormCode *string `json:"formCode,omitempty" validate:"regexp=^\\\\s*\\\\S.*$"`
	StrengthFormCode *StrengthFormCode `json:"strengthFormCode,omitempty"`
	// A NCI Code that specifies the strength unit, e.g., C48152. This shape is deprecated: This field will be replaced by `strengthUnitOfMeasureCode`. This field will no longer be supported starting from 2025-03-12.
	// Deprecated
	UnitOfMeasureCode *string `json:"unitOfMeasureCode,omitempty" validate:"regexp=^\\\\s*\\\\S.*$"`
	StrengthUnitOfMeasureCode *StrengthUnitOfMeasureCode `json:"strengthUnitOfMeasureCode,omitempty"`
}
...
// SetFormCode gets a reference to the given string and assigns it to the FormCode field.
// Deprecated
func (o *Strength) SetFormCode(v string) {
	o.FormCode = &v
}

// GetStrengthFormCode returns the StrengthFormCode field value if set, zero value otherwise.
func (o *Strength) GetStrengthFormCode() StrengthFormCode {
	if o == nil || IsNil(o.StrengthFormCode) {
		var ret StrengthFormCode
		return ret
	}
	return *o.StrengthFormCode
}

// GetStrengthFormCodeOk returns a tuple with the StrengthFormCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Strength) GetStrengthFormCodeOk() (*StrengthFormCode, bool) {
	if o == nil || IsNil(o.StrengthFormCode) {
		return nil, false
	}
	return o.StrengthFormCode, true
}
...
// SetStrengthFormCode gets a reference to the given StrengthFormCode and assigns it to the StrengthFormCode field.
func (o *Strength) SetStrengthFormCode(v StrengthFormCode) {
	o.StrengthFormCode = &v
}
...
// GetStrengthUnitOfMeasureCode returns the StrengthUnitOfMeasureCode field value if set, zero value otherwise.
func (o *Strength) GetStrengthUnitOfMeasureCode() StrengthUnitOfMeasureCode {
	if o == nil || IsNil(o.StrengthUnitOfMeasureCode) {
		var ret StrengthUnitOfMeasureCode
		return ret
	}
	return *o.StrengthUnitOfMeasureCode
}

// GetStrengthUnitOfMeasureCodeOk returns a tuple with the StrengthUnitOfMeasureCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Strength) GetStrengthUnitOfMeasureCodeOk() (*StrengthUnitOfMeasureCode, bool) {
	if o == nil || IsNil(o.StrengthUnitOfMeasureCode) {
		return nil, false
	}
	return o.StrengthUnitOfMeasureCode, true
}
...
// SetStrengthUnitOfMeasureCode gets a reference to the given StrengthUnitOfMeasureCode and assigns it to the StrengthUnitOfMeasureCode field.
func (o *Strength) SetStrengthUnitOfMeasureCode(v StrengthUnitOfMeasureCode) {
	o.StrengthUnitOfMeasureCode = &v
}

func (o Strength) MarshalJSON() ([]byte, error) {
...
func (o Strength) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.StrengthFormCode) {
		toSerialize["strengthFormCode"] = o.StrengthFormCode
	}
	if !IsNil(o.UnitOfMeasureCode) {
		toSerialize["unitOfMeasureCode"] = o.UnitOfMeasureCode
	}
	if !IsNil(o.StrengthUnitOfMeasureCode) {
		toSerialize["strengthUnitOfMeasureCode"] = o.StrengthUnitOfMeasureCode
	}
	return toSerialize, nil
}

type NullableStrength struct {
	value *Strength
	isSet bool
}

func (v NullableStrength) Get() *Strength {
	return v.value
}

func (v *NullableStrength) Set(val *Strength) {
	v.value = val
	v.isSet = true
}

func (v NullableStrength) IsSet() bool {
	return v.isSet
}

func (v *NullableStrength) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStrength(val *Strength) *NullableStrength {
	return &NullableStrength{value: val, isSet: true}
}

func (v NullableStrength) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStrength) UnmarshalJSON(src []byte) error {
	v.isSet = true
