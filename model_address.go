...
// Address Structure representing a physical address.
type Address struct {
	// Address line 1 contains street name and number
	AddressLine1 string `json:"addressLine1" validate:"regexp=^\\\\s*\\\\S.*$"`
	// Address line 2 contains Apt, company info etc
	AddressLine2 *string `json:"addressLine2,omitempty" validate:"regexp=^\\\\s*\\\\S.*$"`
	// The city of the address.
	City string `json:"city" validate:"regexp=^\\\\s*\\\\S.*$"`
