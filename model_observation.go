...
type Observation struct {
	// Used to record patient's vital signs such as weight and height
	Measurement []Measurement `json:"measurement,omitempty"`
	// Additional notes or comments related to the vital sign observations
	ObservationNotes *string `json:"observationNotes,omitempty"`
}
...
// GetObservationNotes returns the ObservationNotes field value if set, zero value otherwise.
func (o *Observation) GetObservationNotes() string {
	if o == nil || IsNil(o.ObservationNotes) {
		var ret string
		return ret
	}
	return *o.ObservationNotes
}

// GetObservationNotesOk returns a tuple with the ObservationNotes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Observation) GetObservationNotesOk() (*string, bool) {
	if o == nil || IsNil(o.ObservationNotes) {
		return nil, false
	}
	return o.ObservationNotes, true
}
...
// SetObservationNotes gets a reference to the given string and assigns it to the ObservationNotes field.
func (o *Observation) SetObservationNotes(v string) {
	o.ObservationNotes = &v
}
...
func (o Observation) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ObservationNotes) {
		toSerialize["observationNotes"] = o.ObservationNotes
	}
