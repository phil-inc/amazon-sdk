...
// checks if the DaysSupplyDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DaysSupplyDetails{}

// DaysSupplyDetails Structure representing the Days Supply details for a rejected claim
type DaysSupplyDetails struct {
	// This gives information about the maximum days supply allowed by Pharmacy Benefit Managers(PBM)
	MaximumDaysSupply *float32 `json:"maximumDaysSupply,omitempty"`
}
...
// GetMaximumDaysSupply returns the MaximumDaysSupply field value if set, zero value otherwise.
func (o *DaysSupplyDetails) GetMaximumDaysSupply() float32 {
	if o == nil || IsNil(o.MaximumDaysSupply) {
		var ret float32
		return ret
	}
	return *o.MaximumDaysSupply
}

// GetMaximumDaysSupplyOk returns a tuple with the MaximumDaysSupply field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DaysSupplyDetails) GetMaximumDaysSupplyOk() (*float32, bool) {
	if o == nil || IsNil(o.MaximumDaysSupply) {
		return nil, false
	}
	return o.MaximumDaysSupply, true
}
...
// SetMaximumDaysSupply gets a reference to the given float32 and assigns it to the MaximumDaysSupply field.
func (o *DaysSupplyDetails) SetMaximumDaysSupply(v float32) {
	o.MaximumDaysSupply = &v
}

func (o DaysSupplyDetails) MarshalJSON() ([]byte, error) {
...
func (o DaysSupplyDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.MaximumDaysSupply) {
		toSerialize["maximumDaysSupply"] = o.MaximumDaysSupply
	}
	return toSerialize, nil
}

type NullableDaysSupplyDetails struct {
	value *DaysSupplyDetails
	isSet bool
}

func (v NullableDaysSupplyDetails) Get() *DaysSupplyDetails {
	return v.value
}

func (v *NullableDaysSupplyDetails) Set(val *DaysSupplyDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableDaysSupplyDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableDaysSupplyDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDaysSupplyDetails(val *DaysSupplyDetails) *NullableDaysSupplyDetails {
	return &NullableDaysSupplyDetails{value: val, isSet: true}
}

func (v NullableDaysSupplyDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDaysSupplyDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
