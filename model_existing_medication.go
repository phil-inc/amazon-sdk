...
// checks if the ExistingMedication type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExistingMedication{}

// ExistingMedication Structure representing an existing/current medication the patient is taking.
type ExistingMedication struct {
...
func (o ExistingMedication) MarshalJSON() ([]byte, error) {
...
func (o ExistingMedication) ToMap() (map[string]interface{}, error) {
...
func (o *ExistingMedication) UnmarshalJSON(data []byte) (err error) {
	...
	varExistingMedication := _ExistingMedication{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExistingMedication)

	if err != nil {
		return err
	}

	*o = ExistingMedication(varExistingMedication)

	return err
}

type NullableExistingMedication struct {
	value *ExistingMedication
	isSet bool
}

func (v NullableExistingMedication) Get() *ExistingMedication {
	return v.value
}

func (v *NullableExistingMedication) Set(val *ExistingMedication) {
	v.value = val
	v.isSet = true
}

func (v NullableExistingMedication) IsSet() bool {
	return v.isSet
}

func (v *NullableExistingMedication) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExistingMedication(val *ExistingMedication) *NullableExistingMedication {
	return &NullableExistingMedication{value: val, isSet: true}
}

func (v NullableExistingMedication) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExistingMedication) UnmarshalJSON(src []byte) error {
	v.isSet = true
