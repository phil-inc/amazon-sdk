...
func main() {
	...
	clientRequestId := "clientRequestId_example" // string | This can be provided by clients and is used to identify client's request. Clients can assign UUID and log it along with their response to track a particular API request.
	xAmzSecurityToken := "xAmzSecurityToken_example" // string | AWS temporary session token will be obtained by connecting to AmazonSecurityTokenService
	putPrescriptionRequestContent := *openapiclient.NewPutPrescriptionRequestContent("PartnerPrescriptionId_example", "PartnerPatientId_example", *openapiclient.NewPrescriber("Npi_example", *openapiclient.NewName("FirstName_example", "LastName_example"), *openapiclient.NewAddress("AddressLine1_example", "City_example", "State_example", "ZipCode_example", "CountryCode_example"), "PrimaryTelephone_example"), *openapiclient.NewMedicationPrescribed("DrugDescription_example", *openapiclient.NewQuantity(float64(123)), "WrittenDate_example", float64(123), "Directions_example", "Ndc_example", "DispenseAsWritten_example"), *openapiclient.NewPharmacy("NcpdpId_example", "Npi_example", "PharmacyName_example", *openapiclient.NewName("FirstName_example", "LastName_example"), *openapiclient.NewAddress("AddressLine1_example", "City_example", "State_example", "ZipCode_example", "CountryCode_example"), "PrimaryTelephone_example")) // PutPrescriptionRequestContent | 
