...
// checks if the DrugDbCode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DrugDbCode{}

// DrugDbCode Coded Drug Structure used in Medication from alternative source databases.
type DrugDbCode struct {
	...
	Code string `json:"code" validate:"regexp=^\\\\s*\\\\S.*$"`
	Qualifier DrugDbCodeQualifier `json:"qualifier"`
}

type _DrugDbCode DrugDbCode
...
func (o DrugDbCode) MarshalJSON() ([]byte, error) {
...
func (o DrugDbCode) ToMap() (map[string]interface{}, error) {
...
func (o *DrugDbCode) UnmarshalJSON(data []byte) (err error) {
	...
	varDrugDbCode := _DrugDbCode{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDrugDbCode)

	if err != nil {
		return err
	}

	*o = DrugDbCode(varDrugDbCode)

	return err
}

type NullableDrugDbCode struct {
	value *DrugDbCode
	isSet bool
}

func (v NullableDrugDbCode) Get() *DrugDbCode {
	return v.value
}

func (v *NullableDrugDbCode) Set(val *DrugDbCode) {
	v.value = val
	v.isSet = true
}

func (v NullableDrugDbCode) IsSet() bool {
	return v.isSet
}

func (v *NullableDrugDbCode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDrugDbCode(val *DrugDbCode) *NullableDrugDbCode {
	return &NullableDrugDbCode{value: val, isSet: true}
}

func (v NullableDrugDbCode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDrugDbCode) UnmarshalJSON(src []byte) error {
	v.isSet = true
