...
// checks if the OrderInsuranceDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderInsuranceDetails{}

// OrderInsuranceDetails Structure containing primary and secondary insurance details for the patient.     This structure is used in cases where the partner provides insurance information with the order request.
type OrderInsuranceDetails struct {
	Primary   OrderInsurance  `json:"primary"`
	Secondary *OrderInsurance `json:"secondary,omitempty"`
}

type _OrderInsuranceDetails OrderInsuranceDetails
...
// SetSecondary gets a reference to the given OrderInsurance and assigns it to the Secondary field.
func (o *OrderInsuranceDetails) SetSecondary(v OrderInsurance) {
	o.Secondary = &v
}

func (o OrderInsuranceDetails) MarshalJSON() ([]byte, error) {
...
func (o OrderInsuranceDetails) ToMap() (map[string]interface{}, error) {
...
func (o *OrderInsuranceDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varOrderInsuranceDetails := _OrderInsuranceDetails{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOrderInsuranceDetails)

	if err != nil {
		return err
	}

	*o = OrderInsuranceDetails(varOrderInsuranceDetails)

	return err
}

type NullableOrderInsuranceDetails struct {
	value *OrderInsuranceDetails
	isSet bool
}

func (v NullableOrderInsuranceDetails) Get() *OrderInsuranceDetails {
	return v.value
}

func (v *NullableOrderInsuranceDetails) Set(val *OrderInsuranceDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderInsuranceDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderInsuranceDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderInsuranceDetails(val *OrderInsuranceDetails) *NullableOrderInsuranceDetails {
	return &NullableOrderInsuranceDetails{value: val, isSet: true}
}

func (v NullableOrderInsuranceDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderInsuranceDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
