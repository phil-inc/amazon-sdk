...
// ContactInfo Structure representing the contact information of the patient.
type ContactInfo struct {
	ContactSystemType ContactSystemType `json:"contactSystemType"`
	// Country code of the phone number
	CountryCode float32 `json:"countryCode"`
	// Phone number of the patient.
	PhoneNumber string `json:"phoneNumber" validate:"regexp=^1?[2-9]\\\\d{2}[2-9]\\\\d{6}$"`
}
...
func NewContactInfo(contactSystemType ContactSystemType, countryCode float32, phoneNumber string) *ContactInfo {
	this := ContactInfo{}
	this.ContactSystemType = contactSystemType
...
// GetContactSystemType returns the ContactSystemType field value
func (o *ContactInfo) GetContactSystemType() ContactSystemType {
	if o == nil {
		var ret ContactSystemType
		return ret
	}

	return o.ContactSystemType
}

// GetContactSystemTypeOk returns a tuple with the ContactSystemType field value
// and a boolean to check if the value has been set.
func (o *ContactInfo) GetContactSystemTypeOk() (*ContactSystemType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ContactSystemType, true
}

// SetContactSystemType sets field value
func (o *ContactInfo) SetContactSystemType(v ContactSystemType) {
	o.ContactSystemType = v
}
...
func (o ContactInfo) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["contactSystemType"] = o.ContactSystemType
