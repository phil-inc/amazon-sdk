...
// checks if the PutOrderResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutOrderResponseContent{}

// PutOrderResponseContent Structure representing the response for placing an order.
type PutOrderResponseContent struct {
	// The partner Order ID of the placed order.
	PartnerOrderId string `json:"partnerOrderId" validate:"regexp=^[0-9a-zA-Z-]{1,40}$"`
}

type _PutOrderResponseContent PutOrderResponseContent
...
func (o PutOrderResponseContent) MarshalJSON() ([]byte, error) {
...
func (o PutOrderResponseContent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["partnerOrderId"] = o.PartnerOrderId
	return toSerialize, nil
}

func (o *PutOrderResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varPutOrderResponseContent := _PutOrderResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPutOrderResponseContent)

	if err != nil {
		return err
	}

	*o = PutOrderResponseContent(varPutOrderResponseContent)

	return err
}

type NullablePutOrderResponseContent struct {
	value *PutOrderResponseContent
	isSet bool
}

func (v NullablePutOrderResponseContent) Get() *PutOrderResponseContent {
	return v.value
}

func (v *NullablePutOrderResponseContent) Set(val *PutOrderResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullablePutOrderResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullablePutOrderResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutOrderResponseContent(val *PutOrderResponseContent) *NullablePutOrderResponseContent {
	return &NullablePutOrderResponseContent{value: val, isSet: true}
}

func (v NullablePutOrderResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutOrderResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
