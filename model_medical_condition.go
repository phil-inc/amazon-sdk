...
// checks if the MedicalCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MedicalCondition{}

// MedicalCondition Structure representing a medical condition of the patient.
type MedicalCondition struct {
	// Patient's condition code. Condition code should follow the ConditionCodeType input's standard code format.
	Code     string            `json:"code" validate:"regexp=^[A-TV-Za-tv-z][0-9][0-9ABab](?:\\\\.[0-9A-KXZa-kxz](?:[0-9A-EXYZa-exyz](?:[0-9A-HXa-hx][0-59A-HJKMNP-Sa-hjkmnp-s]?)?)?)?|U07(?:\\\\.[01])?$"`
	CodeType ConditionCodeType `json:"codeType"`
	// A human-readable text value of the medical condition.
	TextValue *string `json:"textValue,omitempty" validate:"regexp=^\\\\s*\\\\S.*$"`
}

type _MedicalCondition MedicalCondition
...
func (o MedicalCondition) MarshalJSON() ([]byte, error) {
...
func (o MedicalCondition) ToMap() (map[string]interface{}, error) {
...
func (o *MedicalCondition) UnmarshalJSON(data []byte) (err error) {
	...
	varMedicalCondition := _MedicalCondition{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMedicalCondition)

	if err != nil {
		return err
	}

	*o = MedicalCondition(varMedicalCondition)

	return err
}

type NullableMedicalCondition struct {
	value *MedicalCondition
	isSet bool
}

func (v NullableMedicalCondition) Get() *MedicalCondition {
	return v.value
}

func (v *NullableMedicalCondition) Set(val *MedicalCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableMedicalCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableMedicalCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMedicalCondition(val *MedicalCondition) *NullableMedicalCondition {
	return &NullableMedicalCondition{value: val, isSet: true}
}

func (v NullableMedicalCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMedicalCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
