...
// InvalidInputErrorCode Enum representing the different error codes for the input invalid exception failures.  `INVALID_BILLING_ADDRESS`: The provided billing address failed Amazon API address Validation `INCORRECT_COMBINATION_OF_INSURANCES_PROVIDED` : Incorrect combination of Insurance and co-pay cards have been provided.
type InvalidInputErrorCode string

// List of InvalidInputErrorCode
const (
	INVALID_BILLING_ADDRESS                      InvalidInputErrorCode = "INVALID_BILLING_ADDRESS"
	INCORRECT_COMBINATION_OF_INSURANCES_PROVIDED InvalidInputErrorCode = "INCORRECT_COMBINATION_OF_INSURANCES_PROVIDED"
)

// All allowed values of InvalidInputErrorCode enum
var AllowedInvalidInputErrorCodeEnumValues = []InvalidInputErrorCode{
	"INVALID_BILLING_ADDRESS",
	"INCORRECT_COMBINATION_OF_INSURANCES_PROVIDED",
}

func (v *InvalidInputErrorCode) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := InvalidInputErrorCode(value)
	for _, existing := range AllowedInvalidInputErrorCodeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid InvalidInputErrorCode", value)
}

// NewInvalidInputErrorCodeFromValue returns a pointer to a valid InvalidInputErrorCode
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewInvalidInputErrorCodeFromValue(v string) (*InvalidInputErrorCode, error) {
	ev := InvalidInputErrorCode(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for InvalidInputErrorCode: valid values are %v", v, AllowedInvalidInputErrorCodeEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v InvalidInputErrorCode) IsValid() bool {
	for _, existing := range AllowedInvalidInputErrorCodeEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to InvalidInputErrorCode value
func (v InvalidInputErrorCode) Ptr() *InvalidInputErrorCode {
	return &v
}

type NullableInvalidInputErrorCode struct {
	value *InvalidInputErrorCode
	isSet bool
}

func (v NullableInvalidInputErrorCode) Get() *InvalidInputErrorCode {
	return v.value
}

func (v *NullableInvalidInputErrorCode) Set(val *InvalidInputErrorCode) {
	v.value = val
	v.isSet = true
}

func (v NullableInvalidInputErrorCode) IsSet() bool {
	return v.isSet
}

func (v *NullableInvalidInputErrorCode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvalidInputErrorCode(val *InvalidInputErrorCode) *NullableInvalidInputErrorCode {
	return &NullableInvalidInputErrorCode{value: val, isSet: true}
}

func (v NullableInvalidInputErrorCode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvalidInputErrorCode) UnmarshalJSON(src []byte) error {
	v.isSet = true
