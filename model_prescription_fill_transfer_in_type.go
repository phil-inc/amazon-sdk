...
// PrescriptionFillTransferInType Enum representing whether the prescription is previously dispensed or not before transferring to Amazon Pharmacy.  `NEW_RX` - Represents the prescription is new and not dispensed by any other pharmacy before sending to Amazon Pharmacy.  `DISPENSED_BEFORE` - Represent the prescription was dispensed at least once before transferring to Amazon Pharmacy.
type PrescriptionFillTransferInType string

// List of PrescriptionFillTransferInType
const (
	NEW_RX PrescriptionFillTransferInType = "NEW_RX"
	DISPENSED_BEFORE PrescriptionFillTransferInType = "DISPENSED_BEFORE"
)

// All allowed values of PrescriptionFillTransferInType enum
var AllowedPrescriptionFillTransferInTypeEnumValues = []PrescriptionFillTransferInType{
	"NEW_RX",
	"DISPENSED_BEFORE",
}

func (v *PrescriptionFillTransferInType) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PrescriptionFillTransferInType(value)
	for _, existing := range AllowedPrescriptionFillTransferInTypeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PrescriptionFillTransferInType", value)
}

// NewPrescriptionFillTransferInTypeFromValue returns a pointer to a valid PrescriptionFillTransferInType
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPrescriptionFillTransferInTypeFromValue(v string) (*PrescriptionFillTransferInType, error) {
	ev := PrescriptionFillTransferInType(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PrescriptionFillTransferInType: valid values are %v", v, AllowedPrescriptionFillTransferInTypeEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PrescriptionFillTransferInType) IsValid() bool {
	for _, existing := range AllowedPrescriptionFillTransferInTypeEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PrescriptionFillTransferInType value
func (v PrescriptionFillTransferInType) Ptr() *PrescriptionFillTransferInType {
	return &v
}

type NullablePrescriptionFillTransferInType struct {
	value *PrescriptionFillTransferInType
	isSet bool
}

func (v NullablePrescriptionFillTransferInType) Get() *PrescriptionFillTransferInType {
	return v.value
}

func (v *NullablePrescriptionFillTransferInType) Set(val *PrescriptionFillTransferInType) {
	v.value = val
	v.isSet = true
}

func (v NullablePrescriptionFillTransferInType) IsSet() bool {
	return v.isSet
}

func (v *NullablePrescriptionFillTransferInType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrescriptionFillTransferInType(val *PrescriptionFillTransferInType) *NullablePrescriptionFillTransferInType {
	return &NullablePrescriptionFillTransferInType{value: val, isSet: true}
}

func (v NullablePrescriptionFillTransferInType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrescriptionFillTransferInType) UnmarshalJSON(src []byte) error {
	v.isSet = true
