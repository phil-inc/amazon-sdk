...
// DeaSchedule Enum representing the schedule of controlled substances.  `CLASS_I_DEA_SCHEDULE` - Class I DEA Schedule.  `CLASS_II_DEA_SCHEDULE` - Class II DEA Schedule.  `CLASS_III_DEA_SCHEDULE` - Class III DEA Schedule.  `CLASS_IV_DEA_SCHEDULE` - Class IV DEA Schedule.  `CLASS_V_DEA_SCHEDULE` - Class V DEA Schedule.
type DeaSchedule string

// List of DeaSchedule
const (
	C48672 DeaSchedule = "C48672"
	C48675 DeaSchedule = "C48675"
	C48676 DeaSchedule = "C48676"
	C48677 DeaSchedule = "C48677"
	C48679 DeaSchedule = "C48679"
)

// All allowed values of DeaSchedule enum
var AllowedDeaScheduleEnumValues = []DeaSchedule{
	"C48672",
	"C48675",
	"C48676",
	"C48677",
...
func (v *DeaSchedule) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := DeaSchedule(value)
	for _, existing := range AllowedDeaScheduleEnumValues {
	...
	return fmt.Errorf("%+v is not a valid DeaSchedule", value)
}

// NewDeaScheduleFromValue returns a pointer to a valid DeaSchedule
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewDeaScheduleFromValue(v string) (*DeaSchedule, error) {
	ev := DeaSchedule(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for DeaSchedule: valid values are %v", v, AllowedDeaScheduleEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v DeaSchedule) IsValid() bool {
	for _, existing := range AllowedDeaScheduleEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to DeaSchedule value
func (v DeaSchedule) Ptr() *DeaSchedule {
	return &v
}

type NullableDeaSchedule struct {
	value *DeaSchedule
	isSet bool
}

func (v NullableDeaSchedule) Get() *DeaSchedule {
	return v.value
}

func (v *NullableDeaSchedule) Set(val *DeaSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableDeaSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableDeaSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeaSchedule(val *DeaSchedule) *NullableDeaSchedule {
	return &NullableDeaSchedule{value: val, isSet: true}
}

func (v NullableDeaSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeaSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
