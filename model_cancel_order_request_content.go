...
// checks if the CancelOrderRequestContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelOrderRequestContent{}

// CancelOrderRequestContent Structure representing the request for cancelling an order.
type CancelOrderRequestContent struct {
	// The reason for cancelling this order.
	CancellationReason string `json:"cancellationReason" validate:"regexp=^\\\\s*\\\\S.*$"`
}

type _CancelOrderRequestContent CancelOrderRequestContent
...
func NewCancelOrderRequestContent(cancellationReason string) *CancelOrderRequestContent {
	this := CancelOrderRequestContent{}
...
func (o CancelOrderRequestContent) MarshalJSON() ([]byte, error) {
...
func (o CancelOrderRequestContent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["cancellationReason"] = o.CancellationReason
	return toSerialize, nil
}

func (o *CancelOrderRequestContent) UnmarshalJSON(data []byte) (err error) {
	...
	varCancelOrderRequestContent := _CancelOrderRequestContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCancelOrderRequestContent)

	if err != nil {
		return err
	}

	*o = CancelOrderRequestContent(varCancelOrderRequestContent)

	return err
}

type NullableCancelOrderRequestContent struct {
	value *CancelOrderRequestContent
	isSet bool
}

func (v NullableCancelOrderRequestContent) Get() *CancelOrderRequestContent {
	return v.value
}

func (v *NullableCancelOrderRequestContent) Set(val *CancelOrderRequestContent) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelOrderRequestContent) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelOrderRequestContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelOrderRequestContent(val *CancelOrderRequestContent) *NullableCancelOrderRequestContent {
	return &NullableCancelOrderRequestContent{value: val, isSet: true}
}

func (v NullableCancelOrderRequestContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelOrderRequestContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
