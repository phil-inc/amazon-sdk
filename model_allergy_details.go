...
// checks if the AllergyDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllergyDetails{}

// AllergyDetails Structure representing the allergy details of the patient.
type AllergyDetails struct {
	// Currently supported but on path to deprecation as we will plan to switch to allergiesDescriptor This shape is deprecated since 2024-05-15: Use allergiesDescriptor instead
	// Deprecated
	NoKnownAllergies *bool `json:"noKnownAllergies,omitempty"`
	// If noKnownAllergies is false, allergies is required
	Allergies []Allergy `json:"allergies,omitempty"`
	AllergiesDescriptor *AllergiesDescriptor `json:"allergiesDescriptor,omitempty"`
}
...
// GetNoKnownAllergies returns the NoKnownAllergies field value if set, zero value otherwise.
// Deprecated
func (o *AllergyDetails) GetNoKnownAllergies() bool {
	if o == nil || IsNil(o.NoKnownAllergies) {
		var ret bool
		return ret
	}
	return *o.NoKnownAllergies
}

// GetNoKnownAllergiesOk returns a tuple with the NoKnownAllergies field value if set, nil otherwise
...
func (o *AllergyDetails) GetNoKnownAllergiesOk() (*bool, bool) {
	...
	return o.NoKnownAllergies, true
}
...
// SetNoKnownAllergies gets a reference to the given bool and assigns it to the NoKnownAllergies field.
// Deprecated
func (o *AllergyDetails) SetNoKnownAllergies(v bool) {
	o.NoKnownAllergies = &v
}

// GetAllergies returns the Allergies field value if set, zero value otherwise.
func (o *AllergyDetails) GetAllergies() []Allergy {
	if o == nil || IsNil(o.Allergies) {
		var ret []Allergy
		return ret
	}
	return o.Allergies
...
// GetAllergiesOk returns a tuple with the Allergies field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AllergyDetails) GetAllergiesOk() ([]Allergy, bool) {
	if o == nil || IsNil(o.Allergies) {
		return nil, false
	}
	return o.Allergies, true
}
...
// SetAllergies gets a reference to the given []Allergy and assigns it to the Allergies field.
func (o *AllergyDetails) SetAllergies(v []Allergy) {
	o.Allergies = v
}

// GetAllergiesDescriptor returns the AllergiesDescriptor field value if set, zero value otherwise.
func (o *AllergyDetails) GetAllergiesDescriptor() AllergiesDescriptor {
	if o == nil || IsNil(o.AllergiesDescriptor) {
		var ret AllergiesDescriptor
		return ret
	}
	return *o.AllergiesDescriptor
}

// GetAllergiesDescriptorOk returns a tuple with the AllergiesDescriptor field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AllergyDetails) GetAllergiesDescriptorOk() (*AllergiesDescriptor, bool) {
	if o == nil || IsNil(o.AllergiesDescriptor) {
		return nil, false
	}
	return o.AllergiesDescriptor, true
}
...
// SetAllergiesDescriptor gets a reference to the given AllergiesDescriptor and assigns it to the AllergiesDescriptor field.
func (o *AllergyDetails) SetAllergiesDescriptor(v AllergiesDescriptor) {
	o.AllergiesDescriptor = &v
}
...
func (o AllergyDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.NoKnownAllergies) {
		toSerialize["noKnownAllergies"] = o.NoKnownAllergies
	}
	if !IsNil(o.Allergies) {
		toSerialize["allergies"] = o.Allergies
	}
	if !IsNil(o.AllergiesDescriptor) {
		toSerialize["allergiesDescriptor"] = o.AllergiesDescriptor
	}
