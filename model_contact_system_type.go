...
// ContactSystemType Enum representing the type of contact system.  `MOBILE` - Mobile phone contact system.  `HOME` - Home phone contact system.
type ContactSystemType string

// List of ContactSystemType
const (
	MOBILE ContactSystemType = "Mobile"
	HOME   ContactSystemType = "Home"
)

// All allowed values of ContactSystemType enum
var AllowedContactSystemTypeEnumValues = []ContactSystemType{
	"Mobile",
	"Home",
}

func (v *ContactSystemType) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := ContactSystemType(value)
	for _, existing := range AllowedContactSystemTypeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid ContactSystemType", value)
}

// NewContactSystemTypeFromValue returns a pointer to a valid ContactSystemType
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewContactSystemTypeFromValue(v string) (*ContactSystemType, error) {
	ev := ContactSystemType(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for ContactSystemType: valid values are %v", v, AllowedContactSystemTypeEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v ContactSystemType) IsValid() bool {
	for _, existing := range AllowedContactSystemTypeEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to ContactSystemType value
func (v ContactSystemType) Ptr() *ContactSystemType {
	return &v
}

type NullableContactSystemType struct {
	value *ContactSystemType
	isSet bool
}

func (v NullableContactSystemType) Get() *ContactSystemType {
	return v.value
}

func (v *NullableContactSystemType) Set(val *ContactSystemType) {
	v.value = val
	v.isSet = true
}

func (v NullableContactSystemType) IsSet() bool {
	return v.isSet
}

func (v *NullableContactSystemType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactSystemType(val *ContactSystemType) *NullableContactSystemType {
	return &NullableContactSystemType{value: val, isSet: true}
}

func (v NullableContactSystemType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactSystemType) UnmarshalJSON(src []byte) error {
	v.isSet = true
