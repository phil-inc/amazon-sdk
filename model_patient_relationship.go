...
// PatientRelationship The PatientRelationship enum represents the relationship between the patient and the cardholder, as per the NCPDP specification. It is used to indicate the patient's relationship to the insurance cardholder.  `NOT_SPECIFIED` - Indicates patient relationship code of 0 with relationship not specified. This is applied by default if PatientRelationship is not set in the API request.  `CARDHOLDER` - Indicates patient relationship code of 1, where the insurance is used for the cardholder themself, who is the patient.  `SPOUSE` - Indicates patient relationship code of 2, where the insurance is used for the spouse of the cardholder, who is the patient.  `CHILD` - Indicates patient relationship code of 3, where the insurance is used for the child of the cardholder, who is the patient.  `OTHER` - Indicates patient relationship code of 4, where someone other than the cardholder, spouse, or child is the patient.  `STUDENT` - Indicates patient relationship code of 5, where the insurance is used for a student who is the patient.  `DISABLED_DEPENDENT` - Indicates patient relationship code of 6, where the insurance is used for a disabled dependent who is the patient.  `ADULT_DEPENDENT` - Indicates patient relationship code of 7, where the insurance is used for an adult dependent who is the patient.  `SIGNIFICANT_OTHER` - Indicates patient relationship code of 8, where the insurance is used for a significant other of the cardholder who is the patient.
type PatientRelationship string

// List of PatientRelationship
const (
	NOT_SPECIFIED PatientRelationship = "NOT_SPECIFIED"
	CARDHOLDER PatientRelationship = "CARDHOLDER"
	SPOUSE PatientRelationship = "SPOUSE"
	CHILD PatientRelationship = "CHILD"
	OTHER PatientRelationship = "OTHER"
	STUDENT PatientRelationship = "STUDENT"
	DISABLED_DEPENDENT PatientRelationship = "DISABLED_DEPENDENT"
	ADULT_DEPENDENT PatientRelationship = "ADULT_DEPENDENT"
	SIGNIFICANT_OTHER PatientRelationship = "SIGNIFICANT_OTHER"
)

// All allowed values of PatientRelationship enum
var AllowedPatientRelationshipEnumValues = []PatientRelationship{
	"NOT_SPECIFIED",
	"CARDHOLDER",
	"SPOUSE",
	"CHILD",
...
func (v *PatientRelationship) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PatientRelationship(value)
	for _, existing := range AllowedPatientRelationshipEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PatientRelationship", value)
}

// NewPatientRelationshipFromValue returns a pointer to a valid PatientRelationship
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPatientRelationshipFromValue(v string) (*PatientRelationship, error) {
	ev := PatientRelationship(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PatientRelationship: valid values are %v", v, AllowedPatientRelationshipEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PatientRelationship) IsValid() bool {
	for _, existing := range AllowedPatientRelationshipEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PatientRelationship value
func (v PatientRelationship) Ptr() *PatientRelationship {
	return &v
}

type NullablePatientRelationship struct {
	value *PatientRelationship
	isSet bool
}

func (v NullablePatientRelationship) Get() *PatientRelationship {
	return v.value
}

func (v *NullablePatientRelationship) Set(val *PatientRelationship) {
	v.value = val
	v.isSet = true
}

func (v NullablePatientRelationship) IsSet() bool {
	return v.isSet
}

func (v *NullablePatientRelationship) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatientRelationship(val *PatientRelationship) *NullablePatientRelationship {
	return &NullablePatientRelationship{value: val, isSet: true}
}

func (v NullablePatientRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatientRelationship) UnmarshalJSON(src []byte) error {
	v.isSet = true
