...
// checks if the ClaimRejectionReason type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClaimRejectionReason{}

// ClaimRejectionReason Structure representing detailed claim rejection reasons.
type ClaimRejectionReason struct {
	ClaimRejectionType *ClaimRejectionType `json:"claimRejectionType,omitempty"`
	// This field contains the description explaining the claimRejectionType
	RejectionTypeDescription *string                   `json:"rejectionTypeDescription,omitempty" validate:"regexp=^\\\\s*\\\\S.*$"`
	FieldErrors              *FieldErrors              `json:"fieldErrors,omitempty"`
	RejectedInsuranceDetails *RejectedInsuranceDetails `json:"rejectedInsuranceDetails,omitempty"`
	DaysSupplyDetails        *DaysSupplyDetails        `json:"daysSupplyDetails,omitempty"`
}
...
// GetClaimRejectionType returns the ClaimRejectionType field value if set, zero value otherwise.
func (o *ClaimRejectionReason) GetClaimRejectionType() ClaimRejectionType {
	if o == nil || IsNil(o.ClaimRejectionType) {
		var ret ClaimRejectionType
		return ret
	}
	return *o.ClaimRejectionType
}

// GetClaimRejectionTypeOk returns a tuple with the ClaimRejectionType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClaimRejectionReason) GetClaimRejectionTypeOk() (*ClaimRejectionType, bool) {
	if o == nil || IsNil(o.ClaimRejectionType) {
		return nil, false
	}
	return o.ClaimRejectionType, true
}
...
// SetClaimRejectionType gets a reference to the given ClaimRejectionType and assigns it to the ClaimRejectionType field.
func (o *ClaimRejectionReason) SetClaimRejectionType(v ClaimRejectionType) {
	o.ClaimRejectionType = &v
}

// GetRejectionTypeDescription returns the RejectionTypeDescription field value if set, zero value otherwise.
func (o *ClaimRejectionReason) GetRejectionTypeDescription() string {
	if o == nil || IsNil(o.RejectionTypeDescription) {
		var ret string
		return ret
	}
	return *o.RejectionTypeDescription
}

// GetRejectionTypeDescriptionOk returns a tuple with the RejectionTypeDescription field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClaimRejectionReason) GetRejectionTypeDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.RejectionTypeDescription) {
		return nil, false
	}
	return o.RejectionTypeDescription, true
}
...
// SetRejectionTypeDescription gets a reference to the given string and assigns it to the RejectionTypeDescription field.
func (o *ClaimRejectionReason) SetRejectionTypeDescription(v string) {
	o.RejectionTypeDescription = &v
}
...
// SetFieldErrors gets a reference to the given FieldErrors and assigns it to the FieldErrors field.
func (o *ClaimRejectionReason) SetFieldErrors(v FieldErrors) {
	o.FieldErrors = &v
}

// GetRejectedInsuranceDetails returns the RejectedInsuranceDetails field value if set, zero value otherwise.
func (o *ClaimRejectionReason) GetRejectedInsuranceDetails() RejectedInsuranceDetails {
	if o == nil || IsNil(o.RejectedInsuranceDetails) {
		var ret RejectedInsuranceDetails
		return ret
	}
	return *o.RejectedInsuranceDetails
}

// GetRejectedInsuranceDetailsOk returns a tuple with the RejectedInsuranceDetails field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClaimRejectionReason) GetRejectedInsuranceDetailsOk() (*RejectedInsuranceDetails, bool) {
	if o == nil || IsNil(o.RejectedInsuranceDetails) {
		return nil, false
	}
	return o.RejectedInsuranceDetails, true
}
...
// SetRejectedInsuranceDetails gets a reference to the given RejectedInsuranceDetails and assigns it to the RejectedInsuranceDetails field.
func (o *ClaimRejectionReason) SetRejectedInsuranceDetails(v RejectedInsuranceDetails) {
	o.RejectedInsuranceDetails = &v
}

// GetDaysSupplyDetails returns the DaysSupplyDetails field value if set, zero value otherwise.
func (o *ClaimRejectionReason) GetDaysSupplyDetails() DaysSupplyDetails {
	if o == nil || IsNil(o.DaysSupplyDetails) {
		var ret DaysSupplyDetails
		return ret
	}
	return *o.DaysSupplyDetails
}

// GetDaysSupplyDetailsOk returns a tuple with the DaysSupplyDetails field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClaimRejectionReason) GetDaysSupplyDetailsOk() (*DaysSupplyDetails, bool) {
	if o == nil || IsNil(o.DaysSupplyDetails) {
		return nil, false
	}
	return o.DaysSupplyDetails, true
}
...
// SetDaysSupplyDetails gets a reference to the given DaysSupplyDetails and assigns it to the DaysSupplyDetails field.
func (o *ClaimRejectionReason) SetDaysSupplyDetails(v DaysSupplyDetails) {
	o.DaysSupplyDetails = &v
}

func (o ClaimRejectionReason) MarshalJSON() ([]byte, error) {
...
func (o ClaimRejectionReason) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ClaimRejectionType) {
		toSerialize["claimRejectionType"] = o.ClaimRejectionType
	}
	if !IsNil(o.RejectionTypeDescription) {
		toSerialize["rejectionTypeDescription"] = o.RejectionTypeDescription
	}
	if !IsNil(o.FieldErrors) {
		toSerialize["fieldErrors"] = o.FieldErrors
	}
	if !IsNil(o.RejectedInsuranceDetails) {
		toSerialize["rejectedInsuranceDetails"] = o.RejectedInsuranceDetails
	}
	if !IsNil(o.DaysSupplyDetails) {
		toSerialize["daysSupplyDetails"] = o.DaysSupplyDetails
	}
	return toSerialize, nil
}

type NullableClaimRejectionReason struct {
	value *ClaimRejectionReason
	isSet bool
}

func (v NullableClaimRejectionReason) Get() *ClaimRejectionReason {
	return v.value
}

func (v *NullableClaimRejectionReason) Set(val *ClaimRejectionReason) {
	v.value = val
	v.isSet = true
}

func (v NullableClaimRejectionReason) IsSet() bool {
	return v.isSet
}

func (v *NullableClaimRejectionReason) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClaimRejectionReason(val *ClaimRejectionReason) *NullableClaimRejectionReason {
	return &NullableClaimRejectionReason{value: val, isSet: true}
}

func (v NullableClaimRejectionReason) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClaimRejectionReason) UnmarshalJSON(src []byte) error {
	v.isSet = true
