...
// checks if the PutPaymentInstrumentResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutPaymentInstrumentResponseContent{}

// PutPaymentInstrumentResponseContent Structure representing the response for adding a payment instrument.
type PutPaymentInstrumentResponseContent struct {
	// The partner payment instrument ID of the added payment instrument.
	PartnerPaymentInstrumentId string `json:"partnerPaymentInstrumentId" validate:"regexp=^[0-9a-zA-Z-]{1,40}$"`
}

type _PutPaymentInstrumentResponseContent PutPaymentInstrumentResponseContent
...
func NewPutPaymentInstrumentResponseContent(partnerPaymentInstrumentId string) *PutPaymentInstrumentResponseContent {
	this := PutPaymentInstrumentResponseContent{}
...
func (o PutPaymentInstrumentResponseContent) MarshalJSON() ([]byte, error) {
...
func (o PutPaymentInstrumentResponseContent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["partnerPaymentInstrumentId"] = o.PartnerPaymentInstrumentId
	return toSerialize, nil
}

func (o *PutPaymentInstrumentResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varPutPaymentInstrumentResponseContent := _PutPaymentInstrumentResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPutPaymentInstrumentResponseContent)

	if err != nil {
		return err
	}

	*o = PutPaymentInstrumentResponseContent(varPutPaymentInstrumentResponseContent)

	return err
}

type NullablePutPaymentInstrumentResponseContent struct {
	value *PutPaymentInstrumentResponseContent
	isSet bool
}

func (v NullablePutPaymentInstrumentResponseContent) Get() *PutPaymentInstrumentResponseContent {
	return v.value
}

func (v *NullablePutPaymentInstrumentResponseContent) Set(val *PutPaymentInstrumentResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullablePutPaymentInstrumentResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullablePutPaymentInstrumentResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutPaymentInstrumentResponseContent(val *PutPaymentInstrumentResponseContent) *NullablePutPaymentInstrumentResponseContent {
	return &NullablePutPaymentInstrumentResponseContent{value: val, isSet: true}
}

func (v NullablePutPaymentInstrumentResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutPaymentInstrumentResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
