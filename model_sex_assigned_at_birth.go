...
// SexAssignedAtBirth Enum representing the sex assigned at birth.  `FEMALE` - Female sex assigned at birth.  `MALE` - Male sex assigned at birth.
type SexAssignedAtBirth string

// List of SexAssignedAtBirth
const (
	FEMALE SexAssignedAtBirth = "Female"
	MALE   SexAssignedAtBirth = "Male"
)

// All allowed values of SexAssignedAtBirth enum
var AllowedSexAssignedAtBirthEnumValues = []SexAssignedAtBirth{
	"Female",
	"Male",
}

func (v *SexAssignedAtBirth) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := SexAssignedAtBirth(value)
	for _, existing := range AllowedSexAssignedAtBirthEnumValues {
	...
	return fmt.Errorf("%+v is not a valid SexAssignedAtBirth", value)
}

// NewSexAssignedAtBirthFromValue returns a pointer to a valid SexAssignedAtBirth
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewSexAssignedAtBirthFromValue(v string) (*SexAssignedAtBirth, error) {
	ev := SexAssignedAtBirth(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for SexAssignedAtBirth: valid values are %v", v, AllowedSexAssignedAtBirthEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v SexAssignedAtBirth) IsValid() bool {
	for _, existing := range AllowedSexAssignedAtBirthEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to SexAssignedAtBirth value
func (v SexAssignedAtBirth) Ptr() *SexAssignedAtBirth {
	return &v
}

type NullableSexAssignedAtBirth struct {
	value *SexAssignedAtBirth
	isSet bool
}

func (v NullableSexAssignedAtBirth) Get() *SexAssignedAtBirth {
	return v.value
}

func (v *NullableSexAssignedAtBirth) Set(val *SexAssignedAtBirth) {
	v.value = val
	v.isSet = true
}

func (v NullableSexAssignedAtBirth) IsSet() bool {
	return v.isSet
}

func (v *NullableSexAssignedAtBirth) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSexAssignedAtBirth(val *SexAssignedAtBirth) *NullableSexAssignedAtBirth {
	return &NullableSexAssignedAtBirth{value: val, isSet: true}
}

func (v NullableSexAssignedAtBirth) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSexAssignedAtBirth) UnmarshalJSON(src []byte) error {
	v.isSet = true
