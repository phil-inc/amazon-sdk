...
// InsuranceComplianceRuleType Compliance rules for validating insurance combinations and usage  `PAYER_TYPE_RESTRICTION` - Validates allowed combinations of different insurance types. Enforces restrictions between:          - Commercial and discount plans          - Government insurances (Medicare, Medicaid, Other)          - Discount and copay programs `GENERIC_DRUG_RESTRICTION` - Enforces copay card restrictions for generic drugs. Prevents copay card usage with generic medications. Applies to both primary and secondary positions  `GOVERNMENT_INSURANCE_COPAY_RESTRICTION` - Prevents copay card usage when any government insurance exists. Applies to Medicare, Medicaid, and other government plans. Restricts copay cards in both primary and secondary positions
type InsuranceComplianceRuleType string

// List of InsuranceComplianceRuleType
const (
	PAYER_TYPE_RESTRICTION                 InsuranceComplianceRuleType = "PAYER_TYPE_RESTRICTION"
	GENERIC_DRUG_RESTRICTION               InsuranceComplianceRuleType = "GENERIC_DRUG_RESTRICTION"
	GOVERNMENT_INSURANCE_COPAY_RESTRICTION InsuranceComplianceRuleType = "GOVERNMENT_INSURANCE_COPAY_RESTRICTION"
)

// All allowed values of InsuranceComplianceRuleType enum
var AllowedInsuranceComplianceRuleTypeEnumValues = []InsuranceComplianceRuleType{
	"PAYER_TYPE_RESTRICTION",
	"GENERIC_DRUG_RESTRICTION",
	"GOVERNMENT_INSURANCE_COPAY_RESTRICTION",
}

func (v *InsuranceComplianceRuleType) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := InsuranceComplianceRuleType(value)
	for _, existing := range AllowedInsuranceComplianceRuleTypeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid InsuranceComplianceRuleType", value)
}

// NewInsuranceComplianceRuleTypeFromValue returns a pointer to a valid InsuranceComplianceRuleType
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewInsuranceComplianceRuleTypeFromValue(v string) (*InsuranceComplianceRuleType, error) {
	ev := InsuranceComplianceRuleType(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for InsuranceComplianceRuleType: valid values are %v", v, AllowedInsuranceComplianceRuleTypeEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v InsuranceComplianceRuleType) IsValid() bool {
	for _, existing := range AllowedInsuranceComplianceRuleTypeEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to InsuranceComplianceRuleType value
func (v InsuranceComplianceRuleType) Ptr() *InsuranceComplianceRuleType {
	return &v
}

type NullableInsuranceComplianceRuleType struct {
	value *InsuranceComplianceRuleType
	isSet bool
}

func (v NullableInsuranceComplianceRuleType) Get() *InsuranceComplianceRuleType {
	return v.value
}

func (v *NullableInsuranceComplianceRuleType) Set(val *InsuranceComplianceRuleType) {
	v.value = val
	v.isSet = true
}

func (v NullableInsuranceComplianceRuleType) IsSet() bool {
	return v.isSet
}

func (v *NullableInsuranceComplianceRuleType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInsuranceComplianceRuleType(val *InsuranceComplianceRuleType) *NullableInsuranceComplianceRuleType {
	return &NullableInsuranceComplianceRuleType{value: val, isSet: true}
}

func (v NullableInsuranceComplianceRuleType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInsuranceComplianceRuleType) UnmarshalJSON(src []byte) error {
	v.isSet = true
