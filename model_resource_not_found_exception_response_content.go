...
// checks if the ResourceNotFoundExceptionResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceNotFoundExceptionResponseContent{}

// ResourceNotFoundExceptionResponseContent This exception is thrown when a patient, prescription, or order cannot be found.
type ResourceNotFoundExceptionResponseContent struct {
	// A human-readable message describing the resource not found exception.
	Message string `json:"message" validate:"regexp=^\\\\s*\\\\S.*$"`
}

type _ResourceNotFoundExceptionResponseContent ResourceNotFoundExceptionResponseContent
...
func NewResourceNotFoundExceptionResponseContent(message string) *ResourceNotFoundExceptionResponseContent {
	this := ResourceNotFoundExceptionResponseContent{}
...
func (o ResourceNotFoundExceptionResponseContent) MarshalJSON() ([]byte, error) {
...
func (o ResourceNotFoundExceptionResponseContent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["message"] = o.Message
	return toSerialize, nil
}

func (o *ResourceNotFoundExceptionResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varResourceNotFoundExceptionResponseContent := _ResourceNotFoundExceptionResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResourceNotFoundExceptionResponseContent)

	if err != nil {
		return err
	}

	*o = ResourceNotFoundExceptionResponseContent(varResourceNotFoundExceptionResponseContent)

	return err
}

type NullableResourceNotFoundExceptionResponseContent struct {
	value *ResourceNotFoundExceptionResponseContent
	isSet bool
}

func (v NullableResourceNotFoundExceptionResponseContent) Get() *ResourceNotFoundExceptionResponseContent {
	return v.value
}

func (v *NullableResourceNotFoundExceptionResponseContent) Set(val *ResourceNotFoundExceptionResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceNotFoundExceptionResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceNotFoundExceptionResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceNotFoundExceptionResponseContent(val *ResourceNotFoundExceptionResponseContent) *NullableResourceNotFoundExceptionResponseContent {
	return &NullableResourceNotFoundExceptionResponseContent{value: val, isSet: true}
}

func (v NullableResourceNotFoundExceptionResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceNotFoundExceptionResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
