...
// checks if the PutOrder502Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutOrder502Response{}

// PutOrder502Response struct for PutOrder502Response
type PutOrder502Response struct {
...
func (o PutOrder502Response) MarshalJSON() ([]byte, error) {
...
func (o PutOrder502Response) ToMap() (map[string]interface{}, error) {
...
type NullablePutOrder502Response struct {
	value *PutOrder502Response
	isSet bool
}

func (v NullablePutOrder502Response) Get() *PutOrder502Response {
	return v.value
}

func (v *NullablePutOrder502Response) Set(val *PutOrder502Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePutOrder502Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePutOrder502Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutOrder502Response(val *PutOrder502Response) *NullablePutOrder502Response {
	return &NullablePutOrder502Response{value: val, isSet: true}
}

func (v NullablePutOrder502Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutOrder502Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
